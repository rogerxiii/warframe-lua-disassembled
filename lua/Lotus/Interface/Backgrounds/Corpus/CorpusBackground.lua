...
; Command line was: -dis M:\git repos\warframe-lua-disassembled\B.Font.cache_extracted\Lotus\Interface\Backgrounds\Corpus\CorpusBackground.luac 
...
100 [-]: LOADK     R13 K22      ; R13 := "ForegroundContainer.Foreground.Details"
...
106 [-]: LOADK     R13 K23      ; R13 := "ForegroundContainer.Foreground.OuterLines"
107 [-]: LOADK     R14 K10      ; R14 := "_color"
108 [-]: MOVE      R15 R9       ; R15 := R9
109 [-]: CALL      R11 5 1      ; R11(R12,R13,R14,R15)
110 [-]: GETGLOBAL R11 K7       ; R11 := mMovie
111 [-]: SELF      R11 R11 K8   ; R12 := R11; R11 := R11["0x1C19D966"]
112 [-]: LOADK     R13 K24      ; R13 := "ForegroundContainer.Foreground.OuterBorder"
113 [-]: LOADK     R14 K10      ; R14 := "_color"
114 [-]: MOVE      R15 R9       ; R15 := R9
115 [-]: CALL      R11 5 1      ; R11(R12,R13,R14,R15)
116 [-]: GETGLOBAL R11 K7       ; R11 := mMovie
117 [-]: SELF      R11 R11 K8   ; R12 := R11; R11 := R11["0x1C19D966"]
118 [-]: LOADK     R13 K25      ; R13 := "ForegroundContainer.Foreground.Egg"
119 [-]: LOADK     R14 K10      ; R14 := "_color"
120 [-]: MOVE      R15 R9       ; R15 := R9
121 [-]: CALL      R11 5 1      ; R11(R12,R13,R14,R15)
122 [-]: GETGLOBAL R11 K7       ; R11 := mMovie
123 [-]: SELF      R11 R11 K8   ; R12 := R11; R11 := R11["0x1C19D966"]
124 [-]: LOADK     R13 K26      ; R13 := "ForegroundContainer.Foreground.DesignDetail"
125 [-]: LOADK     R14 K10      ; R14 := "_color"
126 [-]: MOVE      R15 R7       ; R15 := R7
127 [-]: CALL      R11 5 1      ; R11(R12,R13,R14,R15)
128 [-]: GETGLOBAL R11 K7       ; R11 := mMovie
129 [-]: SELF      R11 R11 K27  ; R12 := R11; R11 := R11["0x26581636"]
130 [-]: LOADK     R13 K25      ; R13 := "ForegroundContainer.Foreground.Egg"
131 [-]: GETGLOBAL R14 K28      ; R14 := eggTexture
132 [-]: CALL      R11 4 1      ; R11(R12,R13,R14)
133 [-]: GETGLOBAL R11 K7       ; R11 := mMovie
134 [-]: SELF      R11 R11 K29  ; R12 := R11; R11 := R11["0x302AAB2F"]
135 [-]: LOADK     R13 K30      ; R13 := "Bg"
136 [-]: LOADK     R14 K31      ; R14 := "StartColor"
137 [-]: GETTABLE  R15 R0 K32   ; R15 := R0["red"]
138 [-]: DIV       R15 R15 K33  ; R15 := R15 / 255
139 [-]: GETTABLE  R16 R0 K34   ; R16 := R0["green"]
140 [-]: DIV       R16 R16 K33  ; R16 := R16 / 255
141 [-]: GETTABLE  R17 R0 K35   ; R17 := R0["blue"]
142 [-]: DIV       R17 R17 K33  ; R17 := R17 / 255
143 [-]: LOADK     R18 K36      ; R18 := 1
144 [-]: CALL      R11 8 1      ; R11(R12,R13,R14,R15,R16,R17,R18)
145 [-]: GETGLOBAL R11 K7       ; R11 := mMovie
146 [-]: SELF      R11 R11 K29  ; R12 := R11; R11 := R11["0x302AAB2F"]
147 [-]: LOADK     R13 K30      ; R13 := "Bg"
148 [-]: LOADK     R14 K37      ; R14 := "EndColor"
149 [-]: GETTABLE  R15 R1 K32   ; R15 := R1["red"]
150 [-]: DIV       R15 R15 K33  ; R15 := R15 / 255
151 [-]: GETTABLE  R16 R1 K34   ; R16 := R1["green"]
152 [-]: DIV       R16 R16 K33  ; R16 := R16 / 255
153 [-]: GETTABLE  R17 R1 K35   ; R17 := R1["blue"]
154 [-]: DIV       R17 R17 K33  ; R17 := R17 / 255
155 [-]: LOADK     R18 K36      ; R18 := 1
156 [-]: CALL      R11 8 1      ; R11(R12,R13,R14,R15,R16,R17,R18)
157 [-]: LOADNIL   R11 R12      ; R11 := R12 := nil
158 [-]: LOADK     R13 K38      ; R13 := 0
159 [-]: ADD       R13 R13 K36  ; R13 := R13 + 1
160 [-]: LOADK     R14 K39      ; R14 := "Flowers.Flower"
161 [-]: MOVE      R15 R13      ; R15 := R13
162 [-]: CONCAT    R12 R14 R15  ; R12 := R14 .. R15
163 [-]: GETGLOBAL R14 K7       ; R14 := mMovie
164 [-]: SELF      R14 R14 K40  ; R15 := R14; R14 := R14["0x6B7B470B"]
165 [-]: MOVE      R16 R12      ; R16 := R12
166 [-]: CALL      R14 3 2      ; R14 := R14(R15,R16)
167 [-]: MOVE      R11 R14      ; R11 := R14
168 [-]: GETGLOBAL R14 K7       ; R14 := mMovie
169 [-]: SELF      R14 R14 K29  ; R15 := R14; R14 := R14["0x302AAB2F"]
170 [-]: MOVE      R16 R12      ; R16 := R12
171 [-]: LOADK     R17 K41      ; R17 := "RipplesColor"
172 [-]: GETTABLE  R18 R10 K32  ; R18 := R10["red"]
173 [-]: DIV       R18 R18 K33  ; R18 := R18 / 255
174 [-]: GETTABLE  R19 R10 K34  ; R19 := R10["green"]
175 [-]: DIV       R19 R19 K33  ; R19 := R19 / 255
176 [-]: GETTABLE  R20 R10 K35  ; R20 := R10["blue"]
177 [-]: DIV       R20 R20 K33  ; R20 := R20 / 255
178 [-]: LOADK     R21 K42      ; R21 := 0.40000000596046
179 [-]: CALL      R14 8 1      ; R14(R15,R16,R17,R18,R19,R20,R21)
180 [-]: EQ        1 R11 K43    ; if R11 == nil then PC := 184
181 [-]: JMP       184          ; PC := 184
182 [-]: EQ        0 R11 K44    ; if R11 ~= "undefined" then PC := 159
183 [-]: JMP       159          ; PC := 159
184 [-]: GETUPVAL  R14 U1       ; R14 := U1
185 [-]: CALL      R14 1 1      ; R14()
...
; Max Stack Size:  12
  ...
  8 [-]: GETGLOBAL R5 K2        ; R5 := flowersMaterial
  9 [-]: GETGLOBAL R6 K3        ; R6 := flareMaterial
 10 [-]: GETGLOBAL R7 K4        ; R7 := staticFlareMaterial
 11 [-]: GETGLOBAL R8 K5        ; R8 := bgMaterial
