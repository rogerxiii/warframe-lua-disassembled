...
136 [-]: GETGLOBAL R73 K57      ; R73 := Engine
137 [-]: GETTABLE  R73 R73 K58  ; R73 := R73["MULTIPLY"]
138 [-]: SETTABLE  R72 K56 R73  ; R72["op"] := R73
139 [-]: CLOSURE   R73 0        ; R73 := closure(Function #1)
140 [-]: SETTABLE  R72 K59 R73  ; R72["getVal"] := R73
141 [-]: SETTABLE  R72 K60 K61  ; R72["applyToNonHuman"] := "0x1"
142 [-]: NEWTABLE  R73 0 3      ; R73 := {}
143 [-]: GETGLOBAL R74 K54      ; R74 := Game
144 [-]: GETTABLE  R74 R74 K62  ; R74 := R74["AVATAR_HEALTH_MAX"]
145 [-]: SETTABLE  R73 K53 R74  ; R73["upgradeType"] := R74
146 [-]: GETGLOBAL R74 K57      ; R74 := Engine
147 [-]: GETTABLE  R74 R74 K58  ; R74 := R74["MULTIPLY"]
148 [-]: SETTABLE  R73 K56 R74  ; R73["op"] := R74
149 [-]: CLOSURE   R74 1        ; R74 := closure(Function #2)
150 [-]: SETTABLE  R73 K59 R74  ; R73["getVal"] := R74
151 [-]: NEWTABLE  R74 0 3      ; R74 := {}
152 [-]: GETGLOBAL R75 K54      ; R75 := Game
153 [-]: GETTABLE  R75 R75 K63  ; R75 := R75["AVATAR_SHIELD_MAX"]
154 [-]: SETTABLE  R74 K53 R75  ; R74["upgradeType"] := R75
155 [-]: GETGLOBAL R75 K57      ; R75 := Engine
156 [-]: GETTABLE  R75 R75 K58  ; R75 := R75["MULTIPLY"]
157 [-]: SETTABLE  R74 K56 R75  ; R74["op"] := R75
158 [-]: CLOSURE   R75 2        ; R75 := closure(Function #3)
159 [-]: SETTABLE  R74 K59 R75  ; R74["getVal"] := R75
160 [-]: NEWTABLE  R75 0 3      ; R75 := {}
161 [-]: GETGLOBAL R76 K54      ; R76 := Game
162 [-]: GETTABLE  R76 R76 K64  ; R76 := R76["AVATAR_POWER_RATE"]
163 [-]: SETTABLE  R75 K53 R76  ; R75["upgradeType"] := R76
164 [-]: GETGLOBAL R76 K57      ; R76 := Engine
165 [-]: GETTABLE  R76 R76 K65  ; R76 := R76["ADD"]
166 [-]: SETTABLE  R75 K56 R76  ; R75["op"] := R76
167 [-]: CLOSURE   R76 3        ; R76 := closure(Function #4)
168 [-]: SETTABLE  R75 K59 R76  ; R75["getVal"] := R76
...
174 [-]: GETGLOBAL R76 K66      ; R76 := 0x2C00D429
175 [-]: LOADK     R77 K67      ; R77 := "/Lotus/Objects/PVP/CorpusArenaEnemyBannerCloth"
176 [-]: CALL      R76 2 2      ; R76 := R76(R77)
177 [-]: LOADNIL   R77 R77      ; R77 := nil
178 [-]: GETGLOBAL R78 K3       ; R78 := 0xEC274B1A
179 [-]: LOADK     R79 K68      ; R79 := "NeutralTeam"
180 [-]: CALL      R78 2 2      ; R78 := R78(R79)
181 [-]: MOVE      R79 R0       ; R79 := R0
182 [-]: LOADNIL   R80 R80      ; R80 := nil
183 [-]: NEWTABLE  R81 0 0      ; R81 := {}
184 [-]: GETGLOBAL R82 K69      ; R82 := 0x7C282057
185 [-]: LOADK     R83 K70      ; R83 := "/Lotus/Upgrades/Mods/DirectorMods/GreedAiDamageLevelAura"
186 [-]: CALL      R82 2 2      ; R82 := R82(R83)
187 [-]: GETGLOBAL R83 K69      ; R83 := 0x7C282057
188 [-]: LOADK     R84 K71      ; R84 := "/Lotus/Upgrades/Mods/DirectorMods/GreedPlayerTeamDamageLevelAura"
...
310 [-]: SETGLOBAL R107 K72     ; OnLevelLoaded := R107
311 [-]: SETGLOBAL R107 K73     ; 0x58403BFF := R107
...
374 [-]: SETGLOBAL R116 K74     ; OnRoundStarted := R116
375 [-]: SETGLOBAL R116 K75     ; 0x6E420607 := R116
...
421 [-]: SETGLOBAL R118 K76     ; OnUpdate := R118
422 [-]: SETGLOBAL R118 K77     ; 0xA6FE3344 := R118
423 [-]: CLOSURE   R118 38      ; R118 := closure(Function #39)
424 [-]: MOVE      R0 R107      ; R0 := R107
425 [-]: MOVE      R0 R70       ; R0 := R70
426 [-]: MOVE      R0 R71       ; R0 := R71
427 [-]: SETGLOBAL R118 K78     ; OnAvatarChanged := R118
428 [-]: SETGLOBAL R118 K79     ; 0xC88E9F32 := R118
429 [-]: CLOSURE   R118 39      ; R118 := closure(Function #40)
430 [-]: MOVE      R0 R25       ; R0 := R25
431 [-]: MOVE      R0 R92       ; R0 := R92
432 [-]: MOVE      R0 R116      ; R0 := R116
433 [-]: SETGLOBAL R118 K80     ; OnPlayerConnected := R118
434 [-]: SETGLOBAL R118 K81     ; 0xC9DDD994 := R118
...
440 [-]: SETGLOBAL R118 K82     ; OnPlayerDisconnected := R118
441 [-]: SETGLOBAL R118 K83     ; 0xDC194E1E := R118
...
453 [-]: SETGLOBAL R119 K84     ; OnPlayerSpawned := R119
454 [-]: SETGLOBAL R119 K85     ; 0x81331586 := R119
455 [-]: CLOSURE   R119 43      ; R119 := closure(Function #44)
456 [-]: MOVE      R0 R0        ; R0 := R0
457 [-]: SETGLOBAL R119 K86     ; OnLocalAvatarCreated := R119
458 [-]: SETGLOBAL R119 K87     ; 0xE814F6E5 := R119
...
475 [-]: SETGLOBAL R120 K88     ; OnDeath := R120
476 [-]: SETGLOBAL R120 K89     ; 0xC51A1FCE := R120
...
482 [-]: SETGLOBAL R121 K90     ; GetGreedPoint := R121
483 [-]: SETGLOBAL R121 K91     ; 0x361BBA68 := R121
484 [-]: CLOSURE   R121 48      ; R121 := closure(Function #49)
485 [-]: SETGLOBAL R121 K92     ; PickupEvaluate := R121
486 [-]: SETGLOBAL R121 K93     ; 0x7C1DDCD9 := R121
487 [-]: CLOSURE   R121 49      ; R121 := closure(Function #50)
488 [-]: MOVE      R0 R78       ; R0 := R78
489 [-]: SETGLOBAL R121 K94     ; DoNeutralSpawns := R121
490 [-]: SETGLOBAL R121 K95     ; 0x956069D9 := R121
491 [-]: CLOSURE   R121 50      ; R121 := closure(Function #51)
492 [-]: MOVE      R0 R64       ; R0 := R64
493 [-]: MOVE      R0 R58       ; R0 := R58
494 [-]: MOVE      R0 R60       ; R0 := R60
495 [-]: SETGLOBAL R121 K96     ; ZapAvatar := R121
496 [-]: SETGLOBAL R121 K97     ; 0xBCAE58F2 := R121
