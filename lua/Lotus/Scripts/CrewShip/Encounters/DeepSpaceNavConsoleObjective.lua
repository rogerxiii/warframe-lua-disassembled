...
; Command line was: -dis M:\git repos\warframe-lua-disassembled\B.Font.cache_extracted\Lotus\Scripts\CrewShip\Encounters\DeepSpaceNavConsoleObjective.luac 
...
; Max Stack Size:  37
 ...
 34 [-]: LOADK     R26 K18      ; R26 := "RJSpaceConsoleObjectiveMarker"
...
; Max Stack Size:  10
 ...
 69 [-]: JMP       82           ; PC := 82
 70 [-]: GETGLOBAL R2 K18       ; R2 := aiSpec
 71 [-]: MOVE      R2 R10       ; R2 := R10
 72 [-]: GETGLOBAL R2 K18       ; R2 := aiSpec
