...
; Max Stack Size:  8
 ...
 15 [-]: GETTABLE  R6 R6 K6     ; R6 := R6["MULTIPLY"]
 16 [-]: LOADK     R7 K7        ; R7 := 1.5
 ...
 22 [-]: GETTABLE  R5 R5 K8     ; R5 := R5["AVATAR_MOVEMENT_SPEED"]
 23 [-]: GETGLOBAL R6 K5        ; R6 := Engine
 24 [-]: GETTABLE  R6 R6 K6     ; R6 := R6["MULTIPLY"]
 25 [-]: LOADK     R7 K9        ; R7 := 0.60000002384186
 ...
 31 [-]: GETTABLE  R5 R5 K10    ; R5 := R5["WEAPON_DAMAGE_AMOUNT"]
 32 [-]: GETGLOBAL R6 K5        ; R6 := Engine
 33 [-]: GETTABLE  R6 R6 K6     ; R6 := R6["MULTIPLY"]
 34 [-]: LOADK     R7 K11       ; R7 := 2
 ...
 40 [-]: GETTABLE  R5 R5 K12    ; R5 := R5["AVATAR_DAMAGE_RESISTANCE"]
 41 [-]: GETGLOBAL R6 K5        ; R6 := Engine
 42 [-]: GETTABLE  R6 R6 K13    ; R6 := R6["SET"]
 43 [-]: LOADK     R7 K9        ; R7 := 0.60000002384186
 44 [-]: CALL      R3 5 1       ; R3(R4,R5,R6,R7)
 45 [-]: JMP       82           ; PC := 82
 46 [-]: SELF      R3 R1 K1     ; R4 := R1; R3 := R1["0x8DB5D01F"]
 47 [-]: CALL      R3 2 2       ; R3 := R3(R4)
 48 [-]: SELF      R3 R3 K14    ; R4 := R3; R3 := R3["0xF21555A7"]
 49 [-]: GETGLOBAL R5 K3        ; R5 := Game
 50 [-]: GETTABLE  R5 R5 K4     ; R5 := R5["WEAPON_FIRE_RATE"]
 51 [-]: GETGLOBAL R6 K5        ; R6 := Engine
 52 [-]: GETTABLE  R6 R6 K6     ; R6 := R6["MULTIPLY"]
 53 [-]: LOADK     R7 K7        ; R7 := 1.5
 54 [-]: CALL      R3 5 1       ; R3(R4,R5,R6,R7)
 55 [-]: SELF      R3 R1 K1     ; R4 := R1; R3 := R1["0x8DB5D01F"]
 56 [-]: CALL      R3 2 2       ; R3 := R3(R4)
 57 [-]: SELF      R3 R3 K14    ; R4 := R3; R3 := R3["0xF21555A7"]
 58 [-]: GETGLOBAL R5 K3        ; R5 := Game
 59 [-]: GETTABLE  R5 R5 K8     ; R5 := R5["AVATAR_MOVEMENT_SPEED"]
 60 [-]: GETGLOBAL R6 K5        ; R6 := Engine
 61 [-]: GETTABLE  R6 R6 K6     ; R6 := R6["MULTIPLY"]
 62 [-]: LOADK     R7 K9        ; R7 := 0.60000002384186
 63 [-]: CALL      R3 5 1       ; R3(R4,R5,R6,R7)
 64 [-]: SELF      R3 R1 K1     ; R4 := R1; R3 := R1["0x8DB5D01F"]
 65 [-]: CALL      R3 2 2       ; R3 := R3(R4)
 66 [-]: SELF      R3 R3 K14    ; R4 := R3; R3 := R3["0xF21555A7"]
 67 [-]: GETGLOBAL R5 K3        ; R5 := Game
 68 [-]: GETTABLE  R5 R5 K10    ; R5 := R5["WEAPON_DAMAGE_AMOUNT"]
 69 [-]: GETGLOBAL R6 K5        ; R6 := Engine
 70 [-]: GETTABLE  R6 R6 K6     ; R6 := R6["MULTIPLY"]
 71 [-]: LOADK     R7 K11       ; R7 := 2
 72 [-]: CALL      R3 5 1       ; R3(R4,R5,R6,R7)
 73 [-]: SELF      R3 R1 K1     ; R4 := R1; R3 := R1["0x8DB5D01F"]
 74 [-]: CALL      R3 2 2       ; R3 := R3(R4)
 75 [-]: SELF      R3 R3 K14    ; R4 := R3; R3 := R3["0xF21555A7"]
 76 [-]: GETGLOBAL R5 K3        ; R5 := Game
 77 [-]: GETTABLE  R5 R5 K12    ; R5 := R5["AVATAR_DAMAGE_RESISTANCE"]
 78 [-]: GETGLOBAL R6 K5        ; R6 := Engine
 79 [-]: GETTABLE  R6 R6 K13    ; R6 := R6["SET"]
 80 [-]: LOADK     R7 K9        ; R7 := 0.60000002384186
