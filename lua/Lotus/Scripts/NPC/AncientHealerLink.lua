...
; Max Stack Size:  15
  ...
  7 [-]: GETTABLE  R4 R4 K5     ; R4 := R4["ADD"]
  8 [-]: GETGLOBAL R5 K6        ; R5 := lifeStealAmount
 ...
 14 [-]: JMP       94           ; PC := 94
 15 [-]: SELF      R1 R0 K8     ; R2 := R0; R1 := R0["0x5A115A02"]
 16 [-]: CALL      R1 2 2       ; R1 := R1(R2)
 17 [-]: TEST      R1 1         ; if R1 then PC := 94
 18 [-]: JMP       94           ; PC := 94
 19 [-]: GETGLOBAL R1 K7        ; R1 := 0x400E7765
 20 [-]: SELF      R2 R0 K9     ; R3 := R0; R2 := R0["0xF18FC6E4"]
 21 [-]: CALL      R2 2 0       ; R2,... := R2(R3)
 22 [-]: CALL      R1 0 2       ; R1 := R1(R2,...)
 23 [-]: TEST      R1 0         ; if not R1 then PC := 94
 24 [-]: JMP       94           ; PC := 94
 25 [-]: SELF      R1 R0 K10    ; R2 := R0; R1 := R0["0x86E626FB"]
 26 [-]: CALL      R1 2 2       ; R1 := R1(R2)
 27 [-]: GETGLOBAL R2 K11       ; R2 := gRegion
 28 [-]: SELF      R2 R2 K12    ; R3 := R2; R2 := R2["0x2F6A773B"]
 29 [-]: MOVE      R4 R1        ; R4 := R1
 30 [-]: CALL      R2 3 2       ; R2 := R2(R3,R4)
 31 [-]: GETGLOBAL R3 K13       ; R3 := 0x63B09107
 32 [-]: MOVE      R4 R2        ; R4 := R2
 ...
 41 [-]: JMP       80           ; PC := 80
 42 [-]: SELF      R8 R0 K14    ; R9 := R0; R8 := R0["0xCEE55F77"]
 43 [-]: MOVE      R10 R7       ; R10 := R7
 44 [-]: CALL      R8 3 2       ; R8 := R8(R9,R10)
 45 [-]: TEST      R8 0         ; if not R8 then PC := 80
 46 [-]: JMP       80           ; PC := 80
 47 [-]: SELF      R8 R0 K15    ; R9 := R0; R8 := R0["0x83D9304A"]
 48 [-]: MOVE      R10 R7       ; R10 := R7
 49 [-]: CALL      R8 3 2       ; R8 := R8(R9,R10)
 50 [-]: GETGLOBAL R9 K16       ; R9 := healRange
 51 [-]: LE        0 R8 R9      ; if R8 > R9 then PC := 80
 52 [-]: JMP       80           ; PC := 80
 53 [-]: SELF      R8 R0 K17    ; R9 := R0; R8 := R0["0x2D1EF09A"]
 54 [-]: CALL      R8 2 2       ; R8 := R8(R9)
 55 [-]: SELF      R9 R7 K17    ; R10 := R7; R9 := R7["0x2D1EF09A"]
 56 [-]: CALL      R9 2 2       ; R9 := R9(R10)
 57 [-]: EQ        0 R8 R9      ; if R8 ~= R9 then PC := 80
 58 [-]: JMP       80           ; PC := 80
 59 [-]: GETGLOBAL R8 K18       ; R8 := math
 60 [-]: GETTABLE  R8 R8 K19    ; R8 := R8["0x65F9712A"]
 61 [-]: SELF      R9 R7 K20    ; R10 := R7; R9 := R7["0x385BD2FE"]
 62 [-]: CALL      R9 2 2       ; R9 := R9(R10)
 63 [-]: SELF      R10 R7 K21   ; R11 := R7; R10 := R7["0x2F79FBD3"]
 64 [-]: CALL      R10 2 2      ; R10 := R10(R11)
 65 [-]: GETGLOBAL R11 K22      ; R11 := healAmount
 66 [-]: ADD       R10 R10 R11  ; R10 := R10 + R11
 67 [-]: CALL      R8 3 2       ; R8 := R8(R9,R10)
 68 [-]: SELF      R9 R7 K23    ; R10 := R7; R9 := R7["0x76C229EF"]
 69 [-]: MOVE      R11 R8       ; R11 := R8
 70 [-]: CALL      R9 3 1       ; R9(R10,R11)
 71 [-]: SELF      R9 R7 K24    ; R10 := R7; R9 := R7["0xF94A17B9"]
 72 [-]: GETGLOBAL R11 K25      ; R11 := healProjector
 73 [-]: CALL      R9 3 2       ; R9 := R9(R10,R11)
 74 [-]: TEST      R9 1         ; if R9 then PC := 80
 75 [-]: JMP       80           ; PC := 80
 76 [-]: SELF      R9 R7 K26    ; R10 := R7; R9 := R7["0xAB436EF2"]
 77 [-]: GETGLOBAL R11 K25      ; R11 := healProjector
 78 [-]: GETGLOBAL R12 K27      ; R12 := EMPTY_SYMBOL
 79 [-]: CALL      R9 4 1       ; R9(R10,R11,R12)
 80 [-]: TFORLOOP  R3 2         ; R6,R7 :=  R3(R4,R5); if R6 ~= nil then begin PC = 35; R5 := R6 end
 81 [-]: JMP       35           ; PC := 35
 82 [-]: GETGLOBAL R9 K11       ; R9 := gRegion
 83 [-]: SELF      R9 R9 K28    ; R10 := R9; R9 := R9["0xBDD34CC6"]
 84 [-]: GETGLOBAL R11 K29      ; R11 := healfx
 85 [-]: SELF      R12 R0 K30   ; R13 := R0; R12 := R0["0xBBAF192"]
 86 [-]: CALL      R12 2 2      ; R12 := R12(R13)
 87 [-]: SELF      R13 R0 K31   ; R14 := R0; R13 := R0["0xF23A7849"]
 88 [-]: CALL      R13 2 0      ; R13,... := R13(R14)
 89 [-]: CALL      R9 0 1       ; R9(R10,...)
 90 [-]: GETGLOBAL R9 K32       ; R9 := 0x201191EA
 91 [-]: GETGLOBAL R10 K33      ; R10 := healInterval
