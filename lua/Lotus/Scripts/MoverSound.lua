...
; Command line was: -dis M:\git repos\warframe-lua-disassembled\B.Font.cache_extracted\Lotus\Scripts\MoverSound.luac 
...
; Max Stack Size:  2
  ...
  2 [-]: SETGLOBAL R0 K0        ; MoverSound := R0
  3 [-]: SETGLOBAL R0 K1        ; 0x36EBB6D6 := R0
...
; Max Stack Size:  11
  ...
  2 [-]: GETGLOBAL R3 K1        ; R3 := sequencerType
 ...
 15 [-]: GETGLOBAL R4 K1        ; R4 := sequencerType
 ...
 39 [-]: JMP       77           ; PC := 77
 40 [-]: SELF      R4 R0 K6     ; R5 := R0; R4 := R0["0xB2DAC166"]
