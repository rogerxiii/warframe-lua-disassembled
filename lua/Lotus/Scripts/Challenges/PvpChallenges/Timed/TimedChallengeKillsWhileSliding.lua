...
; Command line was: -dis M:\git repos\warframe-lua-disassembled\B.Font.cache_extracted\Lotus\Scripts\Challenges\PvpChallenges\Timed\TimedChallengeKillsWhileSliding.luac 
...
; Max Stack Size:  9
  ...
  1 [-]: GETGLOBAL R5 K0        ; R5 := MyPlayer
  2 [-]: SELF      R5 R5 K1     ; R6 := R5; R5 := R5["0x80B14403"]
  ...
  8 [-]: JMP       19           ; PC := 19
  9 [-]: SELF      R6 R5 K3     ; R7 := R5; R6 := R5["0xFD0BE5BF"]
 10 [-]: CALL      R6 2 2       ; R6 := R6(R7)
 11 [-]: GETGLOBAL R7 K4        ; R7 := Engine
 12 [-]: GETTABLE  R7 R7 K5     ; R7 := R7["SLIDE"]
 13 [-]: EQ        0 R6 R7      ; if R6 ~= R7 then PC := 19
 14 [-]: JMP       19           ; PC := 19
 15 [-]: GETUPVAL  R7 U0        ; R7 := U0
 16 [-]: GETTABLE  R7 R7 K6     ; R7 := R7["0x62758D8E"]
