...
; Command line was: -dis M:\git repos\warframe-lua-disassembled\B.Font.cache_extracted\Lotus\Scripts\Challenges\PvpChallenges\Timed\TimedChallengeKillsMultitool.luac 
...
; Max Stack Size:  8
 ...
 10 [-]: LE        0 K3 R3      ; if 3 > R3 then PC := 16
 11 [-]: JMP       16           ; PC := 16
