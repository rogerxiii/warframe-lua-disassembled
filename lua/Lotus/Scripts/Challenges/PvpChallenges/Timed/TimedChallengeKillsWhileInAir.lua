...
; Command line was: -dis M:\git repos\warframe-lua-disassembled\B.Font.cache_extracted\Lotus\Scripts\Challenges\PvpChallenges\Timed\TimedChallengeKillsWhileInAir.luac 
...
; Max Stack Size:  8
  ...
  2 [-]: GETGLOBAL R6 K1        ; R6 := MyPlayer
  3 [-]: SELF      R6 R6 K2     ; R7 := R6; R6 := R6["0x80B14403"]
 ...
 10 [-]: SELF      R6 R0 K4     ; R7 := R0; R6 := R0["0x144A28F9"]
 11 [-]: CALL      R6 2 2       ; R6 := R6(R7)
 12 [-]: GETTABLE  R5 R5 R6     ; R5 := R5[R6]
 13 [-]: TEST      R5 0         ; if not R5 then PC := 19
 14 [-]: JMP       19           ; PC := 19
 15 [-]: GETUPVAL  R5 U1        ; R5 := U1
 16 [-]: GETTABLE  R5 R5 K5     ; R5 := R5["0x62758D8E"]
...
; Max Stack Size:  12
  ...
  2 [-]: GETGLOBAL R9 K1        ; R9 := MyPlayer
  3 [-]: SELF      R9 R9 K2     ; R10 := R9; R9 := R9["0x80B14403"]
  ...
  9 [-]: JMP       27           ; PC := 27
 10 [-]: SELF      R8 R1 K3     ; R9 := R1; R8 := R1["0x144A28F9"]
 11 [-]: CALL      R8 2 2       ; R8 := R8(R9)
 12 [-]: GETGLOBAL R9 K1        ; R9 := MyPlayer
 13 [-]: SELF      R9 R9 K3     ; R10 := R9; R9 := R9["0x144A28F9"]
 14 [-]: CALL      R9 2 2       ; R9 := R9(R10)
 15 [-]: EQ        0 R8 R9      ; if R8 ~= R9 then PC := 27
 16 [-]: JMP       27           ; PC := 27
 17 [-]: GETUPVAL  R8 U0        ; R8 := U0
 18 [-]: GETTABLE  R8 R8 K4     ; R8 := R8["lastHitWhileFalling"]
 19 [-]: SELF      R9 R0 K3     ; R10 := R0; R9 := R0["0x144A28F9"]
 20 [-]: CALL      R9 2 2       ; R9 := R9(R10)
 21 [-]: GETGLOBAL R10 K1       ; R10 := MyPlayer
 22 [-]: SELF      R10 R10 K2   ; R11 := R10; R10 := R10["0x80B14403"]
 23 [-]: CALL      R10 2 2      ; R10 := R10(R11)
 24 [-]: SELF      R10 R10 K5   ; R11 := R10; R10 := R10["0x18DE1559"]
