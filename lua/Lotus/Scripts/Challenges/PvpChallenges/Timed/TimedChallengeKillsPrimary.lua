...
; Command line was: -dis M:\git repos\warframe-lua-disassembled\B.Font.cache_extracted\Lotus\Scripts\Challenges\PvpChallenges\Timed\TimedChallengeKillsPrimary.luac 
...
; Max Stack Size:  7
  ...
  2 [-]: GETTABLE  R5 R5 K0     ; R5 := R5["HITTYPE_EX_WEAPON_PRIMARY"]
