...
; Command line was: -dis M:\git repos\warframe-lua-disassembled\B.Font.cache_extracted\Lotus\Scripts\Challenges\PvpChallenges\Timed\TimedChallengeKillStreak.luac 
...
; Max Stack Size:  6
  ...
  2 [-]: GETTABLE  R3 R3 K0     ; R3 := R3["KillStreaks"]
  3 [-]: GETGLOBAL R4 K1        ; R4 := MyPlayer
  4 [-]: SELF      R4 R4 K2     ; R5 := R4; R4 := R4["0x144A28F9"]
  5 [-]: CALL      R4 2 2       ; R4 := R4(R5)
  6 [-]: GETTABLE  R3 R3 R4     ; R3 := R3[R4]
  7 [-]: TEST      R3 0         ; if not R3 then PC := 30
  8 [-]: JMP       30           ; PC := 30
  9 [-]: GETUPVAL  R3 U0        ; R3 := U0
 10 [-]: GETTABLE  R3 R3 K0     ; R3 := R3["KillStreaks"]
 ...
 18 [-]: GETTABLE  R3 R3 K0     ; R3 := R3["KillStreaks"]
 19 [-]: GETGLOBAL R4 K1        ; R4 := MyPlayer
 20 [-]: SELF      R4 R4 K2     ; R5 := R4; R4 := R4["0x144A28F9"]
 21 [-]: CALL      R4 2 2       ; R4 := R4(R5)
 22 [-]: GETTABLE  R3 R3 R4     ; R3 := R3[R4]
 23 [-]: MOD       R3 R3 K4     ; R3 := R3 % 3
 24 [-]: EQ        0 R3 K3      ; if R3 ~= 0 then PC := 30
 25 [-]: JMP       30           ; PC := 30
 26 [-]: GETUPVAL  R3 U1        ; R3 := U1
 27 [-]: GETTABLE  R3 R3 K5     ; R3 := R3["0x62758D8E"]
