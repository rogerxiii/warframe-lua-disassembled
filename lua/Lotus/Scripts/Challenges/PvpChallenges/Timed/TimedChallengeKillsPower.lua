...
; Command line was: -dis M:\git repos\warframe-lua-disassembled\B.Font.cache_extracted\Lotus\Scripts\Challenges\PvpChallenges\Timed\TimedChallengeKillsPower.luac 
...
; Max Stack Size:  5
  ...
  2 [-]: GETTABLE  R3 R3 K0     ; R3 := R3["HITTYPE_POWER"]
  3 [-]: EQ        0 R1 R3      ; if R1 ~= R3 then PC := 9
  4 [-]: JMP       9            ; PC := 9
  5 [-]: GETUPVAL  R3 U0        ; R3 := U0
  6 [-]: GETTABLE  R3 R3 K1     ; R3 := R3["0x62758D8E"]
