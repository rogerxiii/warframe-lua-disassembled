...
; Command line was: -dis M:\git repos\warframe-lua-disassembled\B.Font.cache_extracted\Lotus\Scripts\Challenges\PvpChallenges\Timed\TimedChallengeKillsSecondary.luac 
...
; Max Stack Size:  7
  ...
  2 [-]: GETTABLE  R5 R5 K0     ; R5 := R5["HITTYPE_EX_WEAPON_SECONDARY"]
  3 [-]: EQ        0 R4 R5      ; if R4 ~= R5 then PC := 9
  4 [-]: JMP       9            ; PC := 9
  5 [-]: GETUPVAL  R5 U0        ; R5 := U0
  6 [-]: GETTABLE  R5 R5 K1     ; R5 := R5["0x62758D8E"]
