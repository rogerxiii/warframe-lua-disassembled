...
156 [-]: GETGLOBAL R71 K61      ; R71 := Engine
157 [-]: GETTABLE  R71 R71 K62  ; R71 := R71["MULTIPLY"]
158 [-]: SETTABLE  R70 K60 R71  ; R70["Op"] := R71
159 [-]: SETTABLE  R70 K63 K43  ; R70["Val"] := 1
160 [-]: NEWTABLE  R71 0 3      ; R71 := {}
161 [-]: GETGLOBAL R72 K58      ; R72 := Game
162 [-]: GETTABLE  R72 R72 K64  ; R72 := R72["AVATAR_ARMOUR"]
163 [-]: SETTABLE  R71 K57 R72  ; R71["Type"] := R72
164 [-]: GETGLOBAL R72 K61      ; R72 := Engine
165 [-]: GETTABLE  R72 R72 K62  ; R72 := R72["MULTIPLY"]
166 [-]: SETTABLE  R71 K60 R72  ; R71["Op"] := R72
167 [-]: SETTABLE  R71 K63 K43  ; R71["Val"] := 1
168 [-]: NEWTABLE  R72 0 3      ; R72 := {}
169 [-]: GETGLOBAL R73 K58      ; R73 := Game
170 [-]: GETTABLE  R73 R73 K65  ; R73 := R73["AVATAR_SHIELD_MAX"]
171 [-]: SETTABLE  R72 K57 R73  ; R72["Type"] := R73
172 [-]: GETGLOBAL R73 K61      ; R73 := Engine
173 [-]: GETTABLE  R73 R73 K62  ; R73 := R73["MULTIPLY"]
174 [-]: SETTABLE  R72 K60 R73  ; R72["Op"] := R73
175 [-]: SETTABLE  R72 K63 K43  ; R72["Val"] := 1
176 [-]: NEWTABLE  R73 0 3      ; R73 := {}
177 [-]: GETGLOBAL R74 K58      ; R74 := Game
178 [-]: GETTABLE  R74 R74 K66  ; R74 := R74["WEAPON_DAMAGE_AMOUNT"]
179 [-]: SETTABLE  R73 K57 R74  ; R73["Type"] := R74
180 [-]: GETGLOBAL R74 K61      ; R74 := Engine
181 [-]: GETTABLE  R74 R74 K62  ; R74 := R74["MULTIPLY"]
182 [-]: SETTABLE  R73 K60 R74  ; R73["Op"] := R74
183 [-]: SETTABLE  R73 K63 K43  ; R73["Val"] := 1
184 [-]: SETLIST   R69 4 1      ; R69[(1-1)*FPF+i] := R(69+i), 1 <= i <= 4
185 [-]: NEWTABLE  R70 4 0      ; R70 := {}
186 [-]: NEWTABLE  R71 0 2      ; R71 := {}
187 [-]: GETGLOBAL R72 K61      ; R72 := Engine
188 [-]: GETTABLE  R72 R72 K68  ; R72 := R72["SLOT_1"]
189 [-]: SETTABLE  R71 K67 R72  ; R71["Slot"] := R72
...
195 [-]: GETGLOBAL R74 K61      ; R74 := Engine
196 [-]: GETTABLE  R74 R74 K62  ; R74 := R74["MULTIPLY"]
197 [-]: SETTABLE  R73 K60 R74  ; R73["Op"] := R74
198 [-]: SETTABLE  R73 K63 K39  ; R73["Val"] := 0
199 [-]: NEWTABLE  R74 0 3      ; R74 := {}
200 [-]: GETGLOBAL R75 K58      ; R75 := Game
201 [-]: GETTABLE  R75 R75 K66  ; R75 := R75["WEAPON_DAMAGE_AMOUNT"]
202 [-]: SETTABLE  R74 K57 R75  ; R74["Type"] := R75
203 [-]: GETGLOBAL R75 K61      ; R75 := Engine
204 [-]: GETTABLE  R75 R75 K62  ; R75 := R75["MULTIPLY"]
205 [-]: SETTABLE  R74 K60 R75  ; R74["Op"] := R75
206 [-]: SETTABLE  R74 K63 K71  ; R74["Val"] := 1.25
207 [-]: SETLIST   R72 2 1      ; R72[(1-1)*FPF+i] := R(72+i), 1 <= i <= 2
208 [-]: SETTABLE  R71 K69 R72  ; R71["Upgrades"] := R72
209 [-]: NEWTABLE  R72 0 2      ; R72 := {}
210 [-]: GETGLOBAL R73 K61      ; R73 := Engine
211 [-]: GETTABLE  R73 R73 K72  ; R73 := R73["SLOT_2"]
212 [-]: SETTABLE  R72 K67 R73  ; R72["Slot"] := R73
...
218 [-]: GETGLOBAL R75 K61      ; R75 := Engine
219 [-]: GETTABLE  R75 R75 K62  ; R75 := R75["MULTIPLY"]
220 [-]: SETTABLE  R74 K60 R75  ; R74["Op"] := R75
221 [-]: SETTABLE  R74 K63 K39  ; R74["Val"] := 0
222 [-]: NEWTABLE  R75 0 3      ; R75 := {}
223 [-]: GETGLOBAL R76 K58      ; R76 := Game
224 [-]: GETTABLE  R76 R76 K66  ; R76 := R76["WEAPON_DAMAGE_AMOUNT"]
225 [-]: SETTABLE  R75 K57 R76  ; R75["Type"] := R76
226 [-]: GETGLOBAL R76 K61      ; R76 := Engine
227 [-]: GETTABLE  R76 R76 K62  ; R76 := R76["MULTIPLY"]
228 [-]: SETTABLE  R75 K60 R76  ; R75["Op"] := R76
229 [-]: SETTABLE  R75 K63 K71  ; R75["Val"] := 1.25
230 [-]: SETLIST   R73 2 1      ; R73[(1-1)*FPF+i] := R(73+i), 1 <= i <= 2
231 [-]: SETTABLE  R72 K69 R73  ; R72["Upgrades"] := R73
232 [-]: NEWTABLE  R73 0 2      ; R73 := {}
233 [-]: GETGLOBAL R74 K61      ; R74 := Engine
234 [-]: GETTABLE  R74 R74 K73  ; R74 := R74["SLOT_4"]
235 [-]: SETTABLE  R73 K67 R74  ; R73["Slot"] := R74
...
241 [-]: GETGLOBAL R76 K61      ; R76 := Engine
242 [-]: GETTABLE  R76 R76 K62  ; R76 := R76["MULTIPLY"]
243 [-]: SETTABLE  R75 K60 R76  ; R75["Op"] := R76
244 [-]: SETTABLE  R75 K63 K52  ; R75["Val"] := 2
...
264 [-]: GETGLOBAL R77 K61      ; R77 := Engine
265 [-]: GETTABLE  R77 R77 K62  ; R77 := R77["MULTIPLY"]
266 [-]: SETTABLE  R76 K60 R77  ; R76["Op"] := R77
267 [-]: SETTABLE  R76 K63 K40  ; R76["Val"] := 10
268 [-]: NEWTABLE  R77 0 3      ; R77 := {}
269 [-]: GETGLOBAL R78 K58      ; R78 := Game
270 [-]: GETTABLE  R78 R78 K66  ; R78 := R78["WEAPON_DAMAGE_AMOUNT"]
271 [-]: SETTABLE  R77 K57 R78  ; R77["Type"] := R78
272 [-]: GETGLOBAL R78 K61      ; R78 := Engine
273 [-]: GETTABLE  R78 R78 K62  ; R78 := R78["MULTIPLY"]
274 [-]: SETTABLE  R77 K60 R78  ; R77["Op"] := R78
275 [-]: SETTABLE  R77 K63 K71  ; R77["Val"] := 1.25
...
280 [-]: GETGLOBAL R72 K61      ; R72 := Engine
281 [-]: GETTABLE  R72 R72 K68  ; R72 := R72["SLOT_1"]
282 [-]: GETGLOBAL R73 K61      ; R73 := Engine
283 [-]: GETTABLE  R73 R73 K72  ; R73 := R73["SLOT_2"]
284 [-]: GETGLOBAL R74 K61      ; R74 := Engine
285 [-]: GETTABLE  R74 R74 K73  ; R74 := R74["SLOT_4"]
286 [-]: GETGLOBAL R75 K61      ; R75 := Engine
