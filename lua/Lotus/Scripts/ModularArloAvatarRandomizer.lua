...
; Command line was: -dis M:\git repos\warframe-lua-disassembled\B.Font.cache_extracted\Lotus\Scripts\ModularArloAvatarRandomizer.luac 
...
; Max Stack Size:  6
 ...
 16 [-]: MOVE      R2 R0        ; R2 := R0
 17 [-]: GETGLOBAL R3 K5        ; R3 := FeminineLeftArmsTable
 18 [-]: GETGLOBAL R4 K6        ; R4 := FeminineLeftArmsProbabilities
 19 [-]: GETGLOBAL R5 K2        ; R5 := 0xEC274B1A
 20 [-]: CALL      R5 1 0       ; R5,... := R5()
 21 [-]: CALL      R1 0 1       ; R1(R2,...)
 22 [-]: GETUPVAL  R1 U0        ; R1 := U0
 23 [-]: MOVE      R2 R0        ; R2 := R0
 24 [-]: GETGLOBAL R3 K7        ; R3 := FeminineRightArmsTable
 25 [-]: GETGLOBAL R4 K8        ; R4 := FeminineRightArmsProbabilities
 26 [-]: GETGLOBAL R5 K2        ; R5 := 0xEC274B1A
 27 [-]: CALL      R5 1 0       ; R5,... := R5()
 28 [-]: CALL      R1 0 1       ; R1(R2,...)
 29 [-]: GETUPVAL  R1 U0        ; R1 := U0
 30 [-]: MOVE      R2 R0        ; R2 := R0
 31 [-]: GETGLOBAL R3 K9        ; R3 := FeminineLegsTable
 32 [-]: GETGLOBAL R4 K10       ; R4 := FeminineLegsProbabilities
 33 [-]: GETGLOBAL R5 K2        ; R5 := 0xEC274B1A
 34 [-]: CALL      R5 1 0       ; R5,... := R5()
 35 [-]: CALL      R1 0 1       ; R1(R2,...)
 36 [-]: GETGLOBAL R1 K11       ; R1 := gRegion
 37 [-]: SELF      R1 R1 K12    ; R2 := R1; R1 := R1["0xA559F558"]
 38 [-]: CALL      R1 2 2       ; R1 := R1(R2)
 39 [-]: TEST      R1 0         ; if not R1 then PC := 54
 40 [-]: JMP       54           ; PC := 54
 41 [-]: GETGLOBAL R1 K13       ; R1 := FemaleVoiceboxes
 42 [-]: LEN       R1 R1        ; R1 := # R1
 43 [-]: LT        0 K14 R1     ; if 0 >= R1 then PC := 54
 44 [-]: JMP       54           ; PC := 54
 45 [-]: GETGLOBAL R1 K15       ; R1 := 0x7FD4B57D
 46 [-]: LOADK     R2 K16       ; R2 := 1
 47 [-]: GETGLOBAL R3 K13       ; R3 := FemaleVoiceboxes
 48 [-]: LEN       R3 R3        ; R3 := # R3
 49 [-]: CALL      R1 3 2       ; R1 := R1(R2,R3)
 50 [-]: SELF      R2 R0 K17    ; R3 := R0; R2 := R0["0xA50214E5"]
 51 [-]: GETGLOBAL R4 K13       ; R4 := FemaleVoiceboxes
...
; Max Stack Size:  6
 ...
 15 [-]: GETUPVAL  R1 U0        ; R1 := U0
 16 [-]: MOVE      R2 R0        ; R2 := R0
 17 [-]: GETGLOBAL R3 K5        ; R3 := MasculineLeftArmsTable
 18 [-]: GETGLOBAL R4 K6        ; R4 := MasculineLeftArmsProbabilities
 19 [-]: GETGLOBAL R5 K2        ; R5 := 0xEC274B1A
 20 [-]: CALL      R5 1 0       ; R5,... := R5()
 21 [-]: CALL      R1 0 1       ; R1(R2,...)
 22 [-]: GETUPVAL  R1 U0        ; R1 := U0
 23 [-]: MOVE      R2 R0        ; R2 := R0
 24 [-]: GETGLOBAL R3 K7        ; R3 := MasculineRightArmsTable
 25 [-]: GETGLOBAL R4 K8        ; R4 := MasculineRightArmsProbabilities
 26 [-]: GETGLOBAL R5 K2        ; R5 := 0xEC274B1A
 27 [-]: CALL      R5 1 0       ; R5,... := R5()
 28 [-]: CALL      R1 0 1       ; R1(R2,...)
 29 [-]: GETUPVAL  R1 U0        ; R1 := U0
 30 [-]: MOVE      R2 R0        ; R2 := R0
 31 [-]: GETGLOBAL R3 K9        ; R3 := MasculineLegsTable
 32 [-]: GETGLOBAL R4 K10       ; R4 := MasculineLegsProbabilities
 33 [-]: GETGLOBAL R5 K2        ; R5 := 0xEC274B1A
 34 [-]: CALL      R5 1 0       ; R5,... := R5()
 35 [-]: CALL      R1 0 1       ; R1(R2,...)
 36 [-]: GETGLOBAL R1 K11       ; R1 := gRegion
 ...
 39 [-]: TEST      R1 0         ; if not R1 then PC := 54
 40 [-]: JMP       54           ; PC := 54
 41 [-]: GETGLOBAL R1 K13       ; R1 := MaleVoiceboxes
 42 [-]: LEN       R1 R1        ; R1 := # R1
 43 [-]: LT        0 K14 R1     ; if 0 >= R1 then PC := 54
 44 [-]: JMP       54           ; PC := 54
 45 [-]: GETGLOBAL R1 K15       ; R1 := 0x7FD4B57D
 46 [-]: LOADK     R2 K16       ; R2 := 1
 47 [-]: GETGLOBAL R3 K13       ; R3 := MaleVoiceboxes
 48 [-]: LEN       R3 R3        ; R3 := # R3
 49 [-]: CALL      R1 3 2       ; R1 := R1(R2,R3)
 50 [-]: SELF      R2 R0 K17    ; R3 := R0; R2 := R0["0xA50214E5"]
 51 [-]: GETGLOBAL R4 K13       ; R4 := MaleVoiceboxes
 52 [-]: GETTABLE  R4 R4 R1     ; R4 := R4[R1]
 53 [-]: CALL      R2 3 1       ; R2(R3,R4)
 54 [-]: RETURN    R0 1         ; return 
...
; Max Stack Size:  7
  ...
  1 [-]: GETUPVAL  R1 U0        ; R1 := U0
  2 [-]: MOVE      R2 R0        ; R2 := R0
  3 [-]: GETGLOBAL R3 K0        ; R3 := SimpleAttachmentTable
  4 [-]: GETGLOBAL R4 K1        ; R4 := SimpleAttachmentTableProbabilities
  5 [-]: GETGLOBAL R5 K2        ; R5 := 0xEC274B1A
  6 [-]: CALL      R5 1 0       ; R5,... := R5()
  7 [-]: CALL      R1 0 1       ; R1(R2,...)
 ...
 12 [-]: JMP       39           ; PC := 39
 13 [-]: GETGLOBAL R1 K5        ; R1 := WeaponsTable
 14 [-]: LEN       R1 R1        ; R1 := # R1
 15 [-]: LT        0 K6 R1      ; if 0 >= R1 then PC := 39
 16 [-]: JMP       39           ; PC := 39
 17 [-]: LOADK     R2 K7        ; R2 := 1
 18 [-]: GETGLOBAL R3 K8        ; R3 := _T
 19 [-]: GETTABLE  R3 R3 K9     ; R3 := R3["AvatarRandomizerOverrideIndex"]
 20 [-]: EQ        1 R3 K10     ; if R3 == nil then PC := 29
 21 [-]: JMP       29           ; PC := 29
 22 [-]: GETGLOBAL R3 K8        ; R3 := _T
 23 [-]: GETTABLE  R3 R3 K9     ; R3 := R3["AvatarRandomizerOverrideIndex"]
 24 [-]: LE        0 R3 R1      ; if R3 > R1 then PC := 29
 25 [-]: JMP       29           ; PC := 29
 26 [-]: GETGLOBAL R3 K8        ; R3 := _T
 27 [-]: GETTABLE  R2 R3 K9     ; R2 := R3["AvatarRandomizerOverrideIndex"]
 28 [-]: JMP       34           ; PC := 34
 29 [-]: GETGLOBAL R3 K11       ; R3 := 0x7FD4B57D
 30 [-]: LOADK     R4 K7        ; R4 := 1
 31 [-]: MOVE      R5 R1        ; R5 := R1
 32 [-]: CALL      R3 3 2       ; R3 := R3(R4,R5)
 33 [-]: MOVE      R2 R3        ; R2 := R3
 34 [-]: SELF      R3 R0 K12    ; R4 := R0; R3 := R0["0x58347F07"]
 35 [-]: GETGLOBAL R5 K5        ; R5 := WeaponsTable
