...
; Command line was: -dis M:\git repos\warframe-lua-disassembled\B.Font.cache_extracted\Lotus\Scripts\Effects\SyndicateScarves\ArbitersOfHexis.luac 
...
; Max Stack Size:  8
 ...
 46 [-]: GETTABLE  R6 R6 K5     ; R6 := R6["HexisEffects"]
 47 [-]: GETTABLE  R6 R6 R5     ; R6 := R6[R5]
 48 [-]: SETTABLE  R6 K7 K12    ; R6["Flash"] := 1
 49 [-]: GETGLOBAL R6 K4        ; R6 := _T
 50 [-]: GETTABLE  R6 R6 K5     ; R6 := R6["HexisEffects"]
 51 [-]: GETTABLE  R6 R6 R5     ; R6 := R6[R5]
 52 [-]: GETGLOBAL R7 K4        ; R7 := _T
 53 [-]: GETTABLE  R7 R7 K5     ; R7 := R7["HexisEffects"]
 54 [-]: GETTABLE  R7 R7 R5     ; R7 := R7[R5]
 55 [-]: GETTABLE  R7 R7 K9     ; R7 := R7["Total"]
 56 [-]: ADD       R7 R7 K12    ; R7 := R7 + 1
 57 [-]: SETTABLE  R6 K9 R7     ; R6["Total"] := R7
 58 [-]: SELF      R6 R0 K13    ; R7 := R0; R6 := R0["0xF8D7A29E"]
 59 [-]: CALL      R6 2 2       ; R6 := R6(R7)
 60 [-]: TEST      R6 0         ; if not R6 then PC := 75
 61 [-]: JMP       75           ; PC := 75
 62 [-]: GETGLOBAL R6 K4        ; R6 := _T
 63 [-]: GETTABLE  R6 R6 K5     ; R6 := R6["HexisEffects"]
 64 [-]: GETTABLE  R6 R6 R5     ; R6 := R6[R5]
 65 [-]: SETTABLE  R6 K10 K12   ; R6["BloodFlash"] := 1
 66 [-]: GETGLOBAL R6 K4        ; R6 := _T
 67 [-]: GETTABLE  R6 R6 K5     ; R6 := R6["HexisEffects"]
 68 [-]: GETTABLE  R6 R6 R5     ; R6 := R6[R5]
 69 [-]: GETGLOBAL R7 K4        ; R7 := _T
 70 [-]: GETTABLE  R7 R7 K5     ; R7 := R7["HexisEffects"]
 71 [-]: GETTABLE  R7 R7 R5     ; R7 := R7[R5]
 72 [-]: GETTABLE  R7 R7 K11    ; R7 := R7["BloodTotal"]
 73 [-]: ADD       R7 R7 K12    ; R7 := R7 + 1
 74 [-]: SETTABLE  R6 K11 R7    ; R6["BloodTotal"] := R7
 75 [-]: MOVE      R6 R0        ; R6 := R0
