...
; Command line was: -dis M:\git repos\warframe-lua-disassembled\B.Font.cache_extracted\Lotus\Scripts\Eidolon\Encounters\SkiffReinforcements.luac 
...
; Max Stack Size:  8
 ...
 21 [-]: MOVE      R0 R1        ; R0 := R1
 22 [-]: MOVE      R0 R2        ; R0 := R2
 23 [-]: SETGLOBAL R7 K8        ; SkiffReinforcements := R7
 24 [-]: SETGLOBAL R7 K9        ; 0xDADEF90A := R7
 25 [-]: CLOSURE   R7 5         ; R7 := closure(Function #6)
 26 [-]: MOVE      R0 R1        ; R0 := R1
 27 [-]: MOVE      R0 R2        ; R0 := R2
 28 [-]: SETGLOBAL R7 K10       ; SkiffIdleGuards := R7
 29 [-]: SETGLOBAL R7 K11       ; 0xF4652715 := R7
 ...
 35 [-]: MOVE      R0 R1        ; R0 := R1
 36 [-]: MOVE      R0 R2        ; R0 := R2
 37 [-]: SETGLOBAL R7 K12       ; SkiffIdleGuardsFromDistance := R7
 38 [-]: SETGLOBAL R7 K13       ; 0x6A516A7F := R7
...
; Max Stack Size:  29
 ...
 96 [-]: FORPREP   R12 171      ; R12 -= R14; PC := 171
 97 [-]: GETGLOBAL R16 K28      ; R16 := 0x201191EA
 98 [-]: LOADK     R17 K15      ; R17 := 0
 99 [-]: CALL      R16 2 1      ; R16(R17)
100 [-]: SELF      R16 R1 K29   ; R17 := R1; R16 := R1["0x6DD37067"]
101 [-]: GETUPVAL  R18 U2       ; R18 := U2
102 [-]: MOVE      R19 R2       ; R19 := R2
103 [-]: MOVE      R20 R0       ; R20 := R0
104 [-]: MOVE      R21 R0       ; R21 := R0
105 [-]: GETGLOBAL R22 K30      ; R22 := npcTier
106 [-]: MOVE      R23 R1       ; R23 := R1
107 [-]: CALL      R16 8 2      ; R16 := R16(R17,R18,R19,R20,R21,R22,R23)
108 [-]: GETGLOBAL R17 K8       ; R17 := 0x400E7765
109 [-]: MOVE      R18 R16      ; R18 := R16
110 [-]: CALL      R17 2 2      ; R17 := R17(R18)
111 [-]: TEST      R17 1        ; if R17 then PC := 171
112 [-]: JMP       171          ; PC := 171
113 [-]: SELF      R17 R1 K31   ; R18 := R1; R17 := R1["0x81959324"]
114 [-]: MOVE      R19 R16      ; R19 := R16
115 [-]: MOVE      R20 R4       ; R20 := R4
116 [-]: GETGLOBAL R21 K32      ; R21 := squadSpawnRadius
117 [-]: GETUPVAL  R22 U3       ; R22 := U3
118 [-]: MOVE      R23 R2       ; R23 := R2
119 [-]: LOADNIL   R24 R24      ; R24 := nil
120 [-]: GETGLOBAL R25 K33      ; R25 := Engine
121 [-]: GETTABLE  R25 R25 K34  ; R25 := R25["STANDARD"]
122 [-]: LOADK     R26 K35      ; R26 := 65535
123 [-]: MOVE      R27 R0       ; R27 := R0
124 [-]: GETGLOBAL R28 K36      ; R28 := spawnHeight
125 [-]: CALL      R17 12 2     ; R17 := R17(R18,R19,R20,R21,R22,R23,R24,R25,R26,R27,R28)
126 [-]: GETGLOBAL R18 K8       ; R18 := 0x400E7765
127 [-]: MOVE      R19 R17      ; R19 := R17
128 [-]: CALL      R18 2 2      ; R18 := R18(R19)
129 [-]: TEST      R18 1        ; if R18 then PC := 171
130 [-]: JMP       171          ; PC := 171
131 [-]: SELF      R18 R0 K37   ; R19 := R0; R18 := R0["0x1C539F50"]
132 [-]: CALL      R18 2 2      ; R18 := R18(R19)
133 [-]: SELF      R18 R18 K38  ; R19 := R18; R18 := R18["0xD3C0F329"]
134 [-]: MOVE      R20 R17      ; R20 := R17
135 [-]: CALL      R18 3 1      ; R18(R19,R20)
136 [-]: SELF      R18 R17 K39  ; R19 := R17; R18 := R17["0x91ACEF1D"]
137 [-]: CALL      R18 2 1      ; R18(R19)
138 [-]: GETGLOBAL R18 K8       ; R18 := 0x400E7765
139 [-]: MOVE      R19 R0       ; R19 := R0
140 [-]: CALL      R18 2 2      ; R18 := R18(R19)
141 [-]: TEST      R18 1        ; if R18 then PC := 149
142 [-]: JMP       149          ; PC := 149
143 [-]: SELF      R18 R17 K40  ; R19 := R17; R18 := R17["0xD04E9D57"]
144 [-]: GETGLOBAL R20 K41      ; R20 := 0xEC274B1A
145 [-]: LOADK     R21 K42      ; R21 := "StormTarget"
146 [-]: CALL      R20 2 2      ; R20 := R20(R21)
147 [-]: MOVE      R21 R0       ; R21 := R0
148 [-]: CALL      R18 4 1      ; R18(R19,R20,R21)
149 [-]: GETGLOBAL R18 K8       ; R18 := 0x400E7765
150 [-]: SELF      R19 R17 K43  ; R20 := R17; R19 := R17["0x80B14403"]
151 [-]: CALL      R19 2 0      ; R19,... := R19(R20)
152 [-]: CALL      R18 0 2      ; R18 := R18(R19,...)
153 [-]: TEST      R18 1        ; if R18 then PC := 166
154 [-]: JMP       166          ; PC := 166
155 [-]: GETGLOBAL R18 K8       ; R18 := 0x400E7765
156 [-]: GETGLOBAL R19 K44      ; R19 := spawnFx
157 [-]: CALL      R18 2 2      ; R18 := R18(R19)
158 [-]: TEST      R18 1        ; if R18 then PC := 166
159 [-]: JMP       166          ; PC := 166
160 [-]: SELF      R18 R17 K43  ; R19 := R17; R18 := R17["0x80B14403"]
161 [-]: CALL      R18 2 2      ; R18 := R18(R19)
162 [-]: SELF      R18 R18 K45  ; R19 := R18; R18 := R18["0xAB436EF2"]
163 [-]: GETGLOBAL R20 K44      ; R20 := spawnFx
164 [-]: GETGLOBAL R21 K46      ; R21 := EMPTY_SYMBOL
165 [-]: CALL      R18 4 1      ; R18(R19,R20,R21)
166 [-]: GETGLOBAL R18 K47      ; R18 := table
167 [-]: GETTABLE  R18 R18 K48  ; R18 := R18["0xE6450C9D"]
168 [-]: MOVE      R19 R3       ; R19 := R3
169 [-]: MOVE      R20 R17      ; R20 := R17
170 [-]: CALL      R18 3 1      ; R18(R19,R20)
171 [-]: FORLOOP   R12 97       ; R12 += R14; if R12 <= R13 then begin PC := 97; R15 := R12 end
172 [-]: TEST      R5 0         ; if not R5 then PC := 181
173 [-]: JMP       181          ; PC := 181
174 [-]: GETGLOBAL R18 K8       ; R18 := 0x400E7765
175 [-]: MOVE      R19 R4       ; R19 := R4
176 [-]: CALL      R18 2 2      ; R18 := R18(R19)
177 [-]: TEST      R18 1        ; if R18 then PC := 181
178 [-]: JMP       181          ; PC := 181
179 [-]: SELF      R18 R4 K49   ; R19 := R4; R18 := R4["0xD4C2743F"]
180 [-]: CALL      R18 2 1      ; R18(R19)
181 [-]: SELF      R18 R0 K21   ; R19 := R0; R18 := R0["0xB76917A8"]
182 [-]: GETGLOBAL R20 K22      ; R20 := Npc
183 [-]: GETTABLE  R20 R20 K50  ; R20 := R20["ES_COMPLETE"]
