...
110 [-]: GETGLOBAL R62 K59      ; R62 := Engine
111 [-]: GETTABLE  R62 R62 K60  ; R62 := R62["MULTIPLY"]
112 [-]: SETTABLE  R61 K58 R62  ; R61["op"] := R62
113 [-]: CLOSURE   R62 0        ; R62 := closure(Function #1)
114 [-]: SETTABLE  R61 K61 R62  ; R61["getVal"] := R62
115 [-]: SETTABLE  R61 K62 K63  ; R61["applyToNonHuman"] := "0x1"
116 [-]: NEWTABLE  R62 0 3      ; R62 := {}
117 [-]: GETGLOBAL R63 K56      ; R63 := Game
118 [-]: GETTABLE  R63 R63 K64  ; R63 := R63["AVATAR_HEALTH_MAX"]
119 [-]: SETTABLE  R62 K55 R63  ; R62["upgradeType"] := R63
120 [-]: GETGLOBAL R63 K59      ; R63 := Engine
121 [-]: GETTABLE  R63 R63 K60  ; R63 := R63["MULTIPLY"]
122 [-]: SETTABLE  R62 K58 R63  ; R62["op"] := R63
123 [-]: CLOSURE   R63 1        ; R63 := closure(Function #2)
124 [-]: SETTABLE  R62 K61 R63  ; R62["getVal"] := R63
125 [-]: NEWTABLE  R63 0 3      ; R63 := {}
126 [-]: GETGLOBAL R64 K56      ; R64 := Game
127 [-]: GETTABLE  R64 R64 K65  ; R64 := R64["AVATAR_SHIELD_MAX"]
128 [-]: SETTABLE  R63 K55 R64  ; R63["upgradeType"] := R64
129 [-]: GETGLOBAL R64 K59      ; R64 := Engine
130 [-]: GETTABLE  R64 R64 K60  ; R64 := R64["MULTIPLY"]
131 [-]: SETTABLE  R63 K58 R64  ; R63["op"] := R64
132 [-]: CLOSURE   R64 2        ; R64 := closure(Function #3)
133 [-]: SETTABLE  R63 K61 R64  ; R63["getVal"] := R64
134 [-]: NEWTABLE  R64 0 3      ; R64 := {}
135 [-]: GETGLOBAL R65 K56      ; R65 := Game
136 [-]: GETTABLE  R65 R65 K66  ; R65 := R65["AVATAR_POWER_RATE"]
137 [-]: SETTABLE  R64 K55 R65  ; R64["upgradeType"] := R65
138 [-]: GETGLOBAL R65 K59      ; R65 := Engine
139 [-]: GETTABLE  R65 R65 K67  ; R65 := R65["ADD"]
140 [-]: SETTABLE  R64 K58 R65  ; R64["op"] := R65
141 [-]: CLOSURE   R65 3        ; R65 := closure(Function #4)
142 [-]: SETTABLE  R64 K61 R65  ; R64["getVal"] := R65
143 [-]: SETLIST   R60 4 1      ; R60[(1-1)*FPF+i] := R(60+i), 1 <= i <= 4
144 [-]: NEWTABLE  R61 5 0      ; R61 := {}
145 [-]: NEWTABLE  R62 0 3      ; R62 := {}
146 [-]: SETTABLE  R62 K68 K69  ; R62["threshold"] := 1
147 [-]: SETTABLE  R62 K70 K44  ; R62["bonus"] := 0
148 [-]: SETTABLE  R62 K71 K53  ; R62["loc"] := ""
149 [-]: NEWTABLE  R63 0 3      ; R63 := {}
150 [-]: SETTABLE  R63 K68 K46  ; R63["threshold"] := 5
151 [-]: SETTABLE  R63 K70 K72  ; R63["bonus"] := 2
152 [-]: SETTABLE  R63 K71 K73  ; R63["loc"] := "/Lotus/Language/Game/PveGreedDepositBonusTier1"
153 [-]: NEWTABLE  R64 0 3      ; R64 := {}
154 [-]: SETTABLE  R64 K68 K1   ; R64["threshold"] := 10
155 [-]: SETTABLE  R64 K70 K74  ; R64["bonus"] := 4
156 [-]: SETTABLE  R64 K71 K75  ; R64["loc"] := "/Lotus/Language/Game/PveGreedDepositBonusTier2"
157 [-]: NEWTABLE  R65 0 3      ; R65 := {}
158 [-]: SETTABLE  R65 K68 K76  ; R65["threshold"] := 15
159 [-]: SETTABLE  R65 K70 K77  ; R65["bonus"] := 8
160 [-]: SETTABLE  R65 K71 K78  ; R65["loc"] := "/Lotus/Language/Game/PveGreedDepositBonusTier3"
161 [-]: NEWTABLE  R66 0 3      ; R66 := {}
162 [-]: SETTABLE  R66 K68 K79  ; R66["threshold"] := 20
163 [-]: SETTABLE  R66 K70 K1   ; R66["bonus"] := 10
164 [-]: SETTABLE  R66 K71 K80  ; R66["loc"] := "/Lotus/Language/Game/PveGreedDepositBonusTier4"
165 [-]: SETLIST   R61 5 1      ; R61[(1-1)*FPF+i] := R(61+i), 1 <= i <= 5
166 [-]: GETGLOBAL R62 K11      ; R62 := 0xEC274B1A
167 [-]: LOADK     R63 K81      ; R63 := "ProjectIndexBonus"
168 [-]: CALL      R62 2 2      ; R62 := R62(R63)
169 [-]: GETGLOBAL R63 K11      ; R63 := 0xEC274B1A
170 [-]: LOADK     R64 K82      ; R64 := "NeutralTeam"
171 [-]: CALL      R63 2 2      ; R63 := R63(R64)
172 [-]: GETGLOBAL R64 K11      ; R64 := 0xEC274B1A
173 [-]: LOADK     R65 K83      ; R65 := "IndexInvuln"
174 [-]: CALL      R64 2 2      ; R64 := R64(R65)
175 [-]: GETGLOBAL R65 K84      ; R65 := 0x2C00D429
176 [-]: LOADK     R66 K85      ; R66 := "/Lotus/Types/Enemies/CorpusChampions/JohnProdman/JohnProdmanAgent"
177 [-]: CALL      R65 2 2      ; R65 := R65(R66)
178 [-]: LOADK     R66 K86      ; R66 := 3600
179 [-]: MOVE      R67 R0       ; R67 := R0
180 [-]: LOADNIL   R68 R68      ; R68 := nil
181 [-]: GETGLOBAL R69 K11      ; R69 := 0xEC274B1A
182 [-]: LOADK     R70 K87      ; R70 := "IndexQuestMissionD"
183 [-]: CALL      R69 2 2      ; R69 := R69(R70)
184 [-]: GETGLOBAL R70 K11      ; R70 := 0xEC274B1A
185 [-]: LOADK     R71 K88      ; R71 := "IndexQuestMissionE"
186 [-]: CALL      R70 2 2      ; R70 := R70(R71)
187 [-]: MOVE      R71 R0       ; R71 := R0
188 [-]: LOADK     R72 K89      ; R72 := 11
189 [-]: GETGLOBAL R73 K84      ; R73 := 0x2C00D429
190 [-]: LOADK     R74 K90      ; R74 := "/Lotus/Types/Keys/IndexQuest/IndexQuestKeyChain"
191 [-]: CALL      R73 2 2      ; R73 := R73(R74)
192 [-]: GETGLOBAL R74 K84      ; R74 := 0x2C00D429
193 [-]: LOADK     R75 K91      ; R75 := "/Lotus/Types/Enemies/CorpusChampions/TeamC/CCTeamCDeceptionAvatar"
...
245 [-]: SETGLOBAL R83 K92      ; OnDeath := R83
246 [-]: SETGLOBAL R83 K93      ; 0xC51A1FCE := R83
...
265 [-]: SETGLOBAL R86 K94      ; OnCompleteQuestStage := R86
266 [-]: SETGLOBAL R86 K95      ; 0x4B8BAE5 := R86
...
307 [-]: SETGLOBAL R86 K96      ; ReplicaDeathMatch := R86
308 [-]: SETGLOBAL R86 K97      ; 0x3B713ED2 := R86
...
393 [-]: SETGLOBAL R96 K98      ; DeathMatchMission := R96
394 [-]: SETGLOBAL R96 K99      ; 0xB2DBDEC0 := R96
...
415 [-]: SETGLOBAL R96 K100     ; DepositPoints := R96
416 [-]: SETGLOBAL R96 K101     ; 0xF548352 := R96
