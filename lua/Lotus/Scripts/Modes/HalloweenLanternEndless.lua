...
; Command line was: -dis M:\git repos\warframe-lua-disassembled\lua\Lotus\Scripts\Modes\HalloweenLanternEndless.luac 
...
; Max Stack Size:  96
 ...
 58 [-]: LOADNIL   R19 R21      ; R19 := R20 := R21 := nil
 59 [-]: LOADK     R22 K21      ; R22 := 0
 60 [-]: LOADNIL   R23 R26      ; R23 := R24 := R25 := R26 := nil
 61 [-]: LOADK     R27 K21      ; R27 := 0
 62 [-]: LOADNIL   R28 R28      ; R28 := nil
 63 [-]: NEWTABLE  R29 0 0      ; R29 := {}
 64 [-]: LOADNIL   R30 R31      ; R30 := R31 := nil
 65 [-]: MOVE      R32 R0       ; R32 := R0
 66 [-]: NEWTABLE  R33 0 0      ; R33 := {}
 67 [-]: LOADNIL   R34 R35      ; R34 := R35 := nil
 68 [-]: LOADK     R36 K22      ; R36 := 0.5
 69 [-]: NEWTABLE  R37 0 9      ; R37 := {}
 70 [-]: NEWTABLE  R38 4 0      ; R38 := {}
 71 [-]: LOADK     R39 K24      ; R39 := 10
 72 [-]: LOADK     R40 K25      ; R40 := 20
 73 [-]: LOADK     R41 K26      ; R41 := 25
 74 [-]: LOADK     R42 K27      ; R42 := 30
 75 [-]: SETLIST   R38 4 1      ; R38[(1-1)*FPF+i] := R(38+i), 1 <= i <= 4
 76 [-]: SETTABLE  R37 K23 R38  ; R37["numEnemies"] := R38
 77 [-]: SETTABLE  R37 K28 K29  ; R37["tierUpInterval"] := 90
 78 [-]: SETTABLE  R37 K30 K31  ; R37["tierUpAmount"] := 1
 79 [-]: SETTABLE  R37 K32 K33  ; R37["maxTier"] := 5
 80 [-]: SETTABLE  R37 K34 K21  ; R37["leaderStartTime"] := 0
 81 [-]: SETTABLE  R37 K35 K36  ; R37["leaderPeakTime"] := 3000
 82 [-]: SETTABLE  R37 K37 K38  ; R37["leaderMinChance"] := 0.0099999997764826
 83 [-]: SETTABLE  R37 K39 K40  ; R37["leaderMaxChance"] := 0.15000000596046
 84 [-]: SETTABLE  R37 K41 K42  ; R37["scalingTimeInterval"] := 180
 85 [-]: LOADK     R38 K43      ; R38 := 6
 86 [-]: LOADK     R39 K44      ; R39 := 7
 87 [-]: LOADK     R40 K45      ; R40 := 32
 88 [-]: LOADK     R41 K46      ; R41 := 16
 89 [-]: NEWTABLE  R42 4 0      ; R42 := {}
 90 [-]: LOADK     R43 K47      ; R43 := 3.75
 91 [-]: LOADK     R44 K48      ; R44 := 2
 92 [-]: LOADK     R45 K49      ; R45 := 1.75
 93 [-]: LOADK     R46 K50      ; R46 := 1.5
 94 [-]: SETLIST   R42 4 1      ; R42[(1-1)*FPF+i] := R(42+i), 1 <= i <= 4
 95 [-]: LOADK     R43 K31      ; R43 := 1
 96 [-]: LOADK     R44 K51      ; R44 := 0.20000000298023
 97 [-]: NEWTABLE  R45 0 17     ; R45 := {}
 98 [-]: SETTABLE  R45 K52 K53  ; R45["carrier"] := nil
 99 [-]: SETTABLE  R45 K54 K53  ; R45["item"] := nil
100 [-]: SETTABLE  R45 K55 K53  ; R45["radius"] := nil
101 [-]: SETTABLE  R45 K56 K53  ; R45["clampedRadius"] := nil
102 [-]: SETTABLE  R45 K57 K53  ; R45["trigger"] := nil
103 [-]: SETTABLE  R45 K58 K21  ; R45["killCount"] := 0
104 [-]: SETTABLE  R45 K59 K21  ; R45["deathTimer"] := 0
105 [-]: SETTABLE  R45 K60 K21  ; R45["updateTimer"] := 0
106 [-]: SETTABLE  R45 K61 K62  ; R45["warning"] := "0x0"
107 [-]: SETTABLE  R45 K63 K53  ; R45["defaultSeq"] := nil
108 [-]: SETTABLE  R45 K64 K53  ; R45["defaultTickingSeq"] := nil
109 [-]: SETTABLE  R45 K65 K53  ; R45["warningSeq"] := nil
110 [-]: SETTABLE  R45 K66 K53  ; R45["defaultColor"] := nil
111 [-]: SETTABLE  R45 K67 K53  ; R45["warningFx"] := nil
112 [-]: SETTABLE  R45 K68 K53  ; R45["persistentFx"] := nil
113 [-]: SETTABLE  R45 K69 K21  ; R45["initialShrinkTimer"] := 0
114 [-]: SETTABLE  R45 K70 K21  ; R45["respawnTimer"] := 0
115 [-]: NEWTABLE  R46 0 0      ; R46 := {}
116 [-]: SETTABLE  R45 K71 R46  ; R45["avatarStates"] := R46
117 [-]: NEWTABLE  R46 0 4      ; R46 := {}
118 [-]: SETTABLE  R46 K72 K21  ; R46["none"] := 0
119 [-]: SETTABLE  R46 K73 K31  ; R46["normal"] := 1
120 [-]: SETTABLE  R46 K61 K48  ; R46["warning"] := 2
121 [-]: SETTABLE  R46 K74 K75  ; R46["reset"] := 3
122 [-]: NEWTABLE  R47 0 5      ; R47 := {}
123 [-]: SETTABLE  R47 K76 K77  ; R47["b"] := 2.2000000476837
124 [-]: SETTABLE  R47 K78 K79  ; R47["v"] := 0.30000001192093
125 [-]: SETTABLE  R47 K80 K81  ; R47["m"] := 0.03999999910593
126 [-]: SETTABLE  R47 K82 K83  ; R47["p"] := 1.7000000476837
127 [-]: SETTABLE  R47 K84 K21  ; R47["currentRate"] := 0
128 [-]: NEWTABLE  R48 0 11     ; R48 := {}
129 [-]: SETTABLE  R48 K85 K21  ; R48["slow"] := 0
130 [-]: SETTABLE  R48 K86 K21  ; R48["reinf"] := 0
131 [-]: SETTABLE  R48 K87 K21  ; R48["light"] := 0
132 [-]: SETTABLE  R48 K88 K21  ; R48["breakTime"] := 0
133 [-]: SETTABLE  R48 K89 K21  ; R48["lampBreakTime"] := 0
134 [-]: SETTABLE  R48 K90 K21  ; R48["debugT"] := 0
135 [-]: SETTABLE  R48 K91 K21  ; R48["exploitTimer"] := 0
136 [-]: SETTABLE  R48 K92 K21  ; R48["ui"] := 0
137 [-]: SETTABLE  R48 K93 K21  ; R48["delay"] := 0
138 [-]: SETTABLE  R48 K94 K21  ; R48["spawnAreaT"] := 0
139 [-]: SETTABLE  R48 K95 K21  ; R48["triggerT"] := 0
140 [-]: LOADK     R49 K96      ; R49 := 150
141 [-]: LOADK     R50 K97      ; R50 := 300
142 [-]: NEWTABLE  R51 0 4      ; R51 := {}
143 [-]: SETTABLE  R51 K98 K31  ; R51["MISSION_SETUP"] := 1
144 [-]: SETTABLE  R51 K99 K48  ; R51["GET_LAMP"] := 2
145 [-]: SETTABLE  R51 K100 K75 ; R51["ENDLESS"] := 3
146 [-]: SETTABLE  R51 K101 K102; R51["LAMP_EXPIRED"] := 4
147 [-]: GETGLOBAL R52 K0       ; R52 := 0xEC274B1A
148 [-]: LOADK     R53 K103     ; R53 := "EndlessMissionTimeElapsed"
149 [-]: CALL      R52 2 2      ; R52 := R52(R53)
150 [-]: GETGLOBAL R53 K0       ; R53 := 0xEC274B1A
151 [-]: LOADK     R54 K104     ; R54 := "LampRadius"
152 [-]: CALL      R53 2 2      ; R53 := R53(R54)
153 [-]: GETGLOBAL R54 K0       ; R54 := 0xEC274B1A
154 [-]: LOADK     R55 K105     ; R55 := "DeathTimer"
155 [-]: CALL      R54 2 2      ; R54 := R54(R55)
156 [-]: GETGLOBAL R55 K0       ; R55 := 0xEC274B1A
157 [-]: LOADK     R56 K106     ; R56 := "SpawnTimer"
158 [-]: CALL      R55 2 2      ; R55 := R55(R56)
159 [-]: GETGLOBAL R56 K0       ; R56 := 0xEC274B1A
160 [-]: LOADK     R57 K107     ; R57 := "LampStatus"
161 [-]: CALL      R56 2 2      ; R56 := R56(R57)
162 [-]: GETGLOBAL R57 K0       ; R57 := 0xEC274B1A
163 [-]: LOADK     R58 K108     ; R58 := "ReachExtractionTimer"
164 [-]: CALL      R57 2 2      ; R57 := R57(R58)
165 [-]: GETGLOBAL R58 K0       ; R58 := 0xEC274B1A
166 [-]: LOADK     R59 K109     ; R59 := "LanternEndlessBossSpawned"
167 [-]: CALL      R58 2 2      ; R58 := R58(R59)
168 [-]: GETGLOBAL R59 K0       ; R59 := 0xEC274B1A
169 [-]: LOADK     R60 K110     ; R60 := "LanternAreaKillAreaId"
170 [-]: CALL      R59 2 2      ; R59 := R59(R60)
171 [-]: GETGLOBAL R60 K0       ; R60 := 0xEC274B1A
172 [-]: LOADK     R61 K111     ; R61 := "LanternAreaKillTimer"
173 [-]: CALL      R60 2 2      ; R60 := R60(R61)
174 [-]: CLOSURE   R61 0        ; R61 := closure(Function #1)
175 [-]: MOVE      R0 R5        ; R0 := R5
176 [-]: MOVE      R0 R3        ; R0 := R3
177 [-]: MOVE      R0 R19       ; R0 := R19
178 [-]: MOVE      R0 R1        ; R0 := R1
179 [-]: MOVE      R0 R27       ; R0 := R27
180 [-]: CLOSURE   R62 1        ; R62 := closure(Function #2)
181 [-]: MOVE      R0 R19       ; R0 := R19
182 [-]: MOVE      R0 R1        ; R0 := R1
183 [-]: CLOSURE   R63 2        ; R63 := closure(Function #3)
184 [-]: CLOSURE   R64 3        ; R64 := closure(Function #4)
185 [-]: CLOSURE   R65 4        ; R65 := closure(Function #5)
186 [-]: MOVE      R0 R19       ; R0 := R19
187 [-]: MOVE      R0 R8        ; R0 := R8
188 [-]: CLOSURE   R66 5        ; R66 := closure(Function #6)
189 [-]: MOVE      R0 R19       ; R0 := R19
190 [-]: CLOSURE   R67 6        ; R67 := closure(Function #7)
191 [-]: CLOSURE   R68 7        ; R68 := closure(Function #8)
192 [-]: MOVE      R0 R26       ; R0 := R26
193 [-]: MOVE      R0 R10       ; R0 := R10
194 [-]: CLOSURE   R69 8        ; R69 := closure(Function #9)
195 [-]: MOVE      R0 R0        ; R0 := R0
196 [-]: CLOSURE   R70 9        ; R70 := closure(Function #10)
197 [-]: MOVE      R0 R0        ; R0 := R0
198 [-]: CLOSURE   R71 10       ; R71 := closure(Function #11)
199 [-]: MOVE      R0 R69       ; R0 := R69
200 [-]: CLOSURE   R72 11       ; R72 := closure(Function #12)
201 [-]: MOVE      R0 R20       ; R0 := R20
202 [-]: MOVE      R0 R27       ; R0 := R27
203 [-]: MOVE      R0 R37       ; R0 := R37
204 [-]: CLOSURE   R73 12       ; R73 := closure(Function #13)
205 [-]: MOVE      R0 R37       ; R0 := R37
206 [-]: MOVE      R0 R25       ; R0 := R25
207 [-]: CLOSURE   R74 13       ; R74 := closure(Function #14)
208 [-]: MOVE      R0 R27       ; R0 := R27
209 [-]: MOVE      R0 R37       ; R0 := R37
210 [-]: CLOSURE   R75 14       ; R75 := closure(Function #15)
211 [-]: MOVE      R0 R73       ; R0 := R73
212 [-]: MOVE      R0 R72       ; R0 := R72
...
220 [-]: CLOSURE   R76 15       ; R76 := closure(Function #16)
221 [-]: SETGLOBAL R76 K112     ; GrowPumpkin := R76
222 [-]: SETGLOBAL R76 K113     ; 0x70C617C4 := R76
223 [-]: CLOSURE   R76 16       ; R76 := closure(Function #17)
224 [-]: MOVE      R0 R29       ; R0 := R29
225 [-]: MOVE      R0 R9        ; R0 := R9
226 [-]: CLOSURE   R77 17       ; R77 := closure(Function #18)
227 [-]: MOVE      R0 R53       ; R0 := R53
228 [-]: MOVE      R0 R41       ; R0 := R41
229 [-]: CLOSURE   R78 18       ; R78 := closure(Function #19)
230 [-]: MOVE      R0 R53       ; R0 := R53
231 [-]: CLOSURE   R79 19       ; R79 := closure(Function #20)
232 [-]: MOVE      R0 R45       ; R0 := R45
233 [-]: MOVE      R0 R14       ; R0 := R14
234 [-]: MOVE      R0 R21       ; R0 := R21
235 [-]: MOVE      R0 R51       ; R0 := R51
236 [-]: CLOSURE   R80 20       ; R80 := closure(Function #21)
237 [-]: MOVE      R0 R3        ; R0 := R3
238 [-]: MOVE      R0 R70       ; R0 := R70
239 [-]: CLOSURE   R81 21       ; R81 := closure(Function #22)
240 [-]: MOVE      R0 R3        ; R0 := R3
241 [-]: MOVE      R0 R69       ; R0 := R69
242 [-]: CLOSURE   R82 22       ; R82 := closure(Function #23)
243 [-]: MOVE      R0 R45       ; R0 := R45
244 [-]: MOVE      R0 R16       ; R0 := R16
245 [-]: MOVE      R0 R18       ; R0 := R18
246 [-]: MOVE      R0 R17       ; R0 := R17
247 [-]: MOVE      R0 R81       ; R0 := R81
248 [-]: MOVE      R0 R80       ; R0 := R80
249 [-]: CLOSURE   R83 23       ; R83 := closure(Function #24)
250 [-]: MOVE      R0 R45       ; R0 := R45
251 [-]: MOVE      R0 R77       ; R0 := R77
...
275 [-]: MOVE      R0 R78       ; R0 := R78
276 [-]: MOVE      R0 R41       ; R0 := R41
277 [-]: MOVE      R0 R44       ; R0 := R44
278 [-]: MOVE      R0 R43       ; R0 := R43
279 [-]: CLOSURE   R84 24       ; R84 := closure(Function #25)
280 [-]: MOVE      R0 R20       ; R0 := R20
281 [-]: CLOSURE   R85 25       ; R85 := closure(Function #26)
282 [-]: MOVE      R0 R30       ; R0 := R30
283 [-]: MOVE      R0 R20       ; R0 := R20
284 [-]: MOVE      R0 R28       ; R0 := R28
285 [-]: MOVE      R0 R84       ; R0 := R84
286 [-]: CLOSURE   R86 26       ; R86 := closure(Function #27)
287 [-]: MOVE      R0 R45       ; R0 := R45
288 [-]: MOVE      R0 R20       ; R0 := R20
289 [-]: MOVE      R0 R29       ; R0 := R29
290 [-]: MOVE      R0 R35       ; R0 := R35
291 [-]: MOVE      R0 R19       ; R0 := R19
292 [-]: MOVE      R0 R58       ; R0 := R58
293 [-]: CLOSURE   R87 27       ; R87 := closure(Function #28)
294 [-]: MOVE      R0 R28       ; R0 := R28
295 [-]: CLOSURE   R88 28       ; R88 := closure(Function #29)
...
310 [-]: CLOSURE   R89 29       ; R89 := closure(Function #30)
311 [-]: MOVE      R0 R45       ; R0 := R45
312 [-]: CLOSURE   R90 30       ; R90 := closure(Function #31)
...
334 [-]: CLOSURE   R91 31       ; R91 := closure(Function #32)
335 [-]: MOVE      R0 R19       ; R0 := R19
336 [-]: MOVE      R0 R23       ; R0 := R23
337 [-]: MOVE      R0 R25       ; R0 := R25
...
345 [-]: CLOSURE   R92 32       ; R92 := closure(Function #33)
...
383 [-]: MOVE      R0 R57       ; R0 := R57
384 [-]: MOVE      R0 R64       ; R0 := R64
385 [-]: MOVE      R0 R82       ; R0 := R82
386 [-]: CLOSURE   R93 33       ; R93 := closure(Function #34)
387 [-]: MOVE      R0 R26       ; R0 := R26
388 [-]: MOVE      R0 R25       ; R0 := R25
389 [-]: MOVE      R0 R83       ; R0 := R83
390 [-]: CLOSURE   R94 34       ; R94 := closure(Function #35)
...
401 [-]: MOVE      R0 R66       ; R0 := R66
402 [-]: MOVE      R0 R67       ; R0 := R67
403 [-]: MOVE      R0 R24       ; R0 := R24
404 [-]: MOVE      R0 R34       ; R0 := R34
405 [-]: MOVE      R0 R27       ; R0 := R27
406 [-]: MOVE      R0 R1        ; R0 := R1
407 [-]: MOVE      R0 R52       ; R0 := R52
408 [-]: MOVE      R0 R6        ; R0 := R6
409 [-]: MOVE      R0 R63       ; R0 := R63
410 [-]: MOVE      R0 R50       ; R0 := R50
411 [-]: CLOSURE   R95 35       ; R95 := closure(Function #36)
412 [-]: MOVE      R0 R21       ; R0 := R21
413 [-]: MOVE      R0 R4        ; R0 := R4
414 [-]: MOVE      R0 R94       ; R0 := R94
415 [-]: MOVE      R0 R90       ; R0 := R90
416 [-]: MOVE      R0 R91       ; R0 := R91
417 [-]: MOVE      R0 R19       ; R0 := R19
418 [-]: MOVE      R0 R22       ; R0 := R22
419 [-]: MOVE      R0 R92       ; R0 := R92
420 [-]: MOVE      R0 R93       ; R0 := R93
421 [-]: SETGLOBAL R95 K114     ; Mission := R95
422 [-]: SETGLOBAL R95 K115     ; 0x1C7F98F2 := R95
423 [-]: CLOSURE   R95 36       ; R95 := closure(Function #37)
424 [-]: MOVE      R0 R16       ; R0 := R16
425 [-]: SETGLOBAL R95 K116     ; OnDeath := R95
426 [-]: SETGLOBAL R95 K117     ; 0xC51A1FCE := R95
427 [-]: CLOSURE   R95 37       ; R95 := closure(Function #38)
428 [-]: SETGLOBAL R95 K118     ; OnDecodeDeath := R95
429 [-]: SETGLOBAL R95 K119     ; 0x771A4B00 := R95
