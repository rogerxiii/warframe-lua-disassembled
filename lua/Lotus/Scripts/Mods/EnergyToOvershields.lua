...
; Command line was: -dis M:\git repos\warframe-lua-disassembled\B.Font.cache_extracted\Lotus\Scripts\Mods\EnergyToOvershields.luac 
...
; Max Stack Size:  2
  ...
  2 [-]: MUL       R1 K1 R1     ; R1 := 0.20000000298023 * R1
...
; Max Stack Size:  5
  ...
  9 [-]: SETTABLE  R1 K0 R2     ; R1["UPGRADE"] := R2
...
; Max Stack Size:  12
 ...
 16 [-]: GETTABLE  R7 R7 K6     ; R7 := R7["AVATAR_ENERGY_TO_OVERSHIELDS_ON_SPAWN"]
 17 [-]: GETGLOBAL R8 K5        ; R8 := Game
 18 [-]: GETTABLE  R8 R8 K7     ; R8 := R8["MULTIPLY"]
