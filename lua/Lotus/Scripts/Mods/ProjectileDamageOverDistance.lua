...
; Command line was: -dis M:\git repos\warframe-lua-disassembled\B.Font.cache_extracted\Lotus\Scripts\Mods\ProjectileDamageOverDistance.luac 
...
; Max Stack Size:  2
  ...
  2 [-]: MUL       R1 K1 R1     ; R1 := 6 * R1
  3 [-]: SUB       R1 K2 R1     ; R1 := 45 - R1
