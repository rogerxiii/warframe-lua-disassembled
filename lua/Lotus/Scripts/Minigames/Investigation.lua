...
; Command line was: -dis M:\git repos\warframe-lua-disassembled\B.Font.cache_extracted\Lotus\Scripts\Minigames\Investigation.luac 
...
; Max Stack Size:  48
 ...
 49 [-]: GETGLOBAL R26 K20      ; R26 := 0x1E4F6281
 50 [-]: CALL      R26 1 2      ; R26 := R26()
 51 [-]: GETGLOBAL R27 K21      ; R27 := 0x329BDC44
 52 [-]: LOADK     R28 K22      ; R28 := "EE.Interface.Utilities"
 53 [-]: CALL      R27 2 2      ; R27 := R27(R28)
 54 [-]: GETGLOBAL R28 K21      ; R28 := 0x329BDC44
 55 [-]: LOADK     R29 K23      ; R29 := "Lotus.Interface.LotusUtilities"
 ...
 69 [-]: SETGLOBAL R34 K24      ; OnConfirmExit := R34
 70 [-]: SETGLOBAL R34 K25      ; 0xBA9C2A61 := R34
 ...
 90 [-]: SETGLOBAL R38 K26      ; InspectDrop := R38
 91 [-]: SETGLOBAL R38 K27      ; 0x29D0DBA := R38
...
103 [-]: SETGLOBAL R39 K28      ; InspectPickUp := R39
104 [-]: SETGLOBAL R39 K29      ; 0x716A691 := R39
...
110 [-]: SETGLOBAL R40 K30      ; HoldItem := R40
111 [-]: SETGLOBAL R40 K31      ; 0xAEE86254 := R40
...
117 [-]: SETGLOBAL R40 K32      ; ZoomLerp := R40
118 [-]: SETGLOBAL R40 K33      ; 0xAEF17AE := R40
...
126 [-]: SETGLOBAL R40 K34      ; UnzoomLerp := R40
127 [-]: SETGLOBAL R40 K35      ; 0x70AB6BE3 := R40
128 [-]: CLOSURE   R40 17       ; R40 := closure(Function #18)
129 [-]: MOVE      R0 R29       ; R0 := R29
130 [-]: MOVE      R0 R2        ; R0 := R2
131 [-]: MOVE      R0 R27       ; R0 := R27
132 [-]: SETGLOBAL R40 K36      ; ZoomSpot := R40
133 [-]: SETGLOBAL R40 K37      ; 0xB12CC093 := R40
...
196 [-]: SETGLOBAL R47 K38      ; EnableInvestigationMode := R47
197 [-]: SETGLOBAL R47 K39      ; 0xEB2398CC := R47
