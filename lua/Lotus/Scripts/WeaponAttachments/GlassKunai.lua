...
; Command line was: -dis M:\git repos\warframe-lua-disassembled\B.Font.cache_extracted\Lotus\Scripts\WeaponAttachments\GlassKunai.luac 
...
; Max Stack Size:  13
 ...
 23 [-]: GETTABLE  R8 R8 K10    ; R8 := R8["WEAPON_PROJECTILE_SPEED"]
 24 [-]: GETGLOBAL R9 K9        ; R9 := Game
 25 [-]: GETTABLE  R9 R9 K11    ; R9 := R9["STACKING_MULTIPLY"]
 26 [-]: GETGLOBAL R10 K12      ; R10 := projSpeed
