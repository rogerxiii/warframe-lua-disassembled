...
; Command line was: -dis M:\git repos\warframe-lua-disassembled\lua\Lotus\Scripts\WeaponAttachments\TnOdaliskSmgPistol.luac 
...
; Max Stack Size:  13
 ...
 23 [-]: GETTABLE  R8 R8 K10    ; R8 := R8["WEAPON_AMMO_CONSUME_RATE"]
 24 [-]: GETGLOBAL R9 K2        ; R9 := Engine
 25 [-]: GETTABLE  R9 R9 K11    ; R9 := R9["ADD"]
 26 [-]: GETGLOBAL R10 K12      ; R10 := ammoEfficiency
