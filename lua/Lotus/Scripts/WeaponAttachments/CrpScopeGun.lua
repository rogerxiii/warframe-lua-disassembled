...
; Command line was: -dis M:\git repos\warframe-lua-disassembled\B.Font.cache_extracted\Lotus\Scripts\WeaponAttachments\CrpScopeGun.luac 
...
; Max Stack Size:  13
  ...
  3 [-]: CALL      R1 2 1       ; R1(R2)
  4 [-]: LOADK     R1 K1        ; R1 := 0
  5 [-]: LOADK     R2 K2        ; R2 := 1.7999999523163
  6 [-]: SELF      R3 R0 K3     ; R4 := R0; R3 := R0["0x6DA72501"]
  7 [-]: CALL      R3 2 2       ; R3 := R3(R4)
  8 [-]: SELF      R4 R0 K4     ; R5 := R0; R4 := R0["0x6FB15CA5"]
 ...
 14 [-]: JMP       52           ; PC := 52
 15 [-]: LT        0 R1 K6      ; if R1 >= 1 then PC := 52
 16 [-]: JMP       52           ; PC := 52
 17 [-]: GETGLOBAL R5 K7        ; R5 := beamTravelLength
 18 [-]: LT        0 K1 R5      ; if 0 >= R5 then PC := 34
 19 [-]: JMP       34           ; PC := 34
 20 [-]: SELF      R5 R0 K8     ; R6 := R0; R5 := R0["0xEC183DDC"]
 21 [-]: GETGLOBAL R7 K9        ; R7 := 0xE0C881B4
 22 [-]: MOVE      R8 R3        ; R8 := R3
 23 [-]: MOVE      R9 R4        ; R9 := R4
 24 [-]: GETGLOBAL R10 K10      ; R10 := math
 25 [-]: GETTABLE  R10 R10 K11  ; R10 := R10["0xD6F2D811"]
 26 [-]: SUB       R11 K6 R1    ; R11 := 1 - R1
 27 [-]: LOADK     R12 K12      ; R12 := 2
 28 [-]: CALL      R10 3 2      ; R10 := R10(R11,R12)
 29 [-]: SUB       R10 K6 R10   ; R10 := 1 - R10
 30 [-]: GETGLOBAL R11 K7       ; R11 := beamTravelLength
 31 [-]: MUL       R10 R10 R11  ; R10 := R10 * R11
 32 [-]: CALL      R7 4 0       ; R7,... := R7(R8,R9,R10)
 33 [-]: CALL      R5 0 1       ; R5(R6,...)
 34 [-]: GETGLOBAL R5 K10       ; R5 := math
 35 [-]: GETTABLE  R5 R5 K11    ; R5 := R5["0xD6F2D811"]
 36 [-]: MOVE      R6 R1        ; R6 := R1
 37 [-]: LOADK     R7 K13       ; R7 := 3
 38 [-]: CALL      R5 3 2       ; R5 := R5(R6,R7)
 39 [-]: SUB       R5 K6 R5     ; R5 := 1 - R5
 40 [-]: SELF      R6 R0 K14    ; R7 := R0; R6 := R0["0xE767ECA4"]
 41 [-]: GETGLOBAL R8 K15       ; R8 := chargedRadius
 42 [-]: MUL       R8 R5 R8     ; R8 := R5 * R8
 43 [-]: CALL      R6 3 1       ; R6(R7,R8)
 44 [-]: GETGLOBAL R6 K16       ; R6 := 0x4CDEF9FF
 45 [-]: CALL      R6 1 2       ; R6 := R6()
 46 [-]: MUL       R6 R6 R2     ; R6 := R6 * R2
 47 [-]: ADD       R1 R1 R6     ; R1 := R1 + R6
 48 [-]: GETGLOBAL R6 K0        ; R6 := 0x201191EA
 49 [-]: LOADK     R7 K1        ; R7 := 0
