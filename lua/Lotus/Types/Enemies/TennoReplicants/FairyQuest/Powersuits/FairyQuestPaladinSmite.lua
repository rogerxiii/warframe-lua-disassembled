...
; Command line was: -dis M:\git repos\warframe-lua-disassembled\lua\Lotus\Types\Enemies\TennoReplicants\FairyQuest\Powersuits\FairyQuestPaladinSmite.luac 
...
; Max Stack Size:  13
 ...
 98 [-]: GETGLOBAL R8 K6        ; R8 := Engine
 99 [-]: GETTABLE  R8 R8 K7     ; R8 := R8["ADD"]
100 [-]: GETUPVAL  R9 U0        ; R9 := U0
101 [-]: LOADNIL   R10 R11      ; R10 := R11 := nil
102 [-]: GETGLOBAL R12 K6       ; R12 := Engine
