...
; Command line was: -dis M:\git repos\warframe-lua-disassembled\B.Font.cache_extracted\Lotus\Types\Enemies\Corpus\Drones\Vip\RaptorTwoBeam.luac 
...
; Max Stack Size:  3
 ...
 12 [-]: MOVE      R0 R1        ; R0 := R1
 13 [-]: MOVE      R0 R0        ; R0 := R0
 14 [-]: SETGLOBAL R2 K5        ; ChargedBeam := R2
 15 [-]: SETGLOBAL R2 K6        ; 0xB3CA74E8 := R2
...
; Max Stack Size:  6
 ...
 42 [-]: JMP       45           ; PC := 45
 43 [-]: SELF      R3 R0 K14    ; R4 := R0; R3 := R0["0xD4C2743F"]
