...
; Command line was: -dis M:\git repos\warframe-lua-disassembled\lua\Lotus\Sounds\Ambience\GrineerForest\ForestTitaniaShrine\Scripts\TurnOffTriggersIfNotQuest.luac 
