...
; Command line was: -dis M:\git repos\warframe-lua-disassembled\lua\Lotus\Upgrades\CosmeticEnhancers\OperatorArmour\VoidFirewall.luac 
...
; Max Stack Size:  27
 ...
 63 [-]: GETGLOBAL R15 K19      ; R15 := Engine
 64 [-]: GETTABLE  R15 R15 K20  ; R15 := R15["ADD"]
 65 [-]: GETUPVAL  R16 U1       ; R16 := U1
 66 [-]: CALL      R12 5 1      ; R12(R13,R14,R15,R16)
 67 [-]: SELF      R12 R0 K21   ; R13 := R0; R12 := R0["0xAB436EF2"]
 68 [-]: GETGLOBAL R14 K22      ; R14 := decoType
 69 [-]: GETUPVAL  R15 U2       ; R15 := U2
 70 [-]: GETGLOBAL R16 K23      ; R16 := ZERO_VECTOR
 71 [-]: GETGLOBAL R17 K24      ; R17 := 0x1E4F6281
 72 [-]: SUB       R18 R11 K25  ; R18 := R11 - 180
 73 [-]: GETGLOBAL R19 K3       ; R19 := math
 74 [-]: GETTABLE  R19 R19 K26  ; R19 := R19["0x865961F7"]
 75 [-]: LOADK     R20 K27      ; R20 := -15
 76 [-]: LOADK     R21 K28      ; R21 := 15
 77 [-]: CALL      R19 3 2      ; R19 := R19(R20,R21)
 78 [-]: GETGLOBAL R20 K3       ; R20 := math
 79 [-]: GETTABLE  R20 R20 K26  ; R20 := R20["0x865961F7"]
 80 [-]: LOADK     R21 K27      ; R21 := -15
 81 [-]: LOADK     R22 K28      ; R22 := 15
 ...
 87 [-]: SETTABLE  R13 K29 R6   ; R13["timer"] := R6
 88 [-]: SETTABLE  R13 K30 R12  ; R13["effect"] := R12
 89 [-]: GETGLOBAL R14 K31      ; R14 := table
 90 [-]: GETTABLE  R14 R14 K32  ; R14 := R14["0xE6450C9D"]
 91 [-]: MOVE      R15 R9       ; R15 := R9
 92 [-]: MOVE      R16 R13      ; R16 := R13
 93 [-]: CALL      R14 3 1      ; R14(R15,R16)
 94 [-]: ADD       R14 R11 K33  ; R14 := R11 + 80
 95 [-]: MOD       R11 R14 K34  ; R11 := R14 % 360
 96 [-]: JMP       102          ; PC := 102
...
103 [-]: GETGLOBAL R15 K35      ; R15 := _T
104 [-]: GETTABLE  R15 R15 K36  ; R15 := R15["voidFirewallDamaged"]
105 [-]: CALL      R14 2 2      ; R14 := R14(R15)
106 [-]: TEST      R14 1        ; if R14 then PC := 156
107 [-]: JMP       156          ; PC := 156
108 [-]: GETGLOBAL R14 K11      ; R14 := 0x400E7765
109 [-]: GETGLOBAL R15 K35      ; R15 := _T
110 [-]: GETTABLE  R15 R15 K36  ; R15 := R15["voidFirewallDamaged"]
111 [-]: GETTABLE  R15 R15 R8   ; R15 := R15[R8]
112 [-]: CALL      R14 2 2      ; R14 := R14(R15)
113 [-]: TEST      R14 1        ; if R14 then PC := 156
114 [-]: JMP       156          ; PC := 156
115 [-]: GETGLOBAL R14 K35      ; R14 := _T
116 [-]: GETTABLE  R14 R14 K36  ; R14 := R14["voidFirewallDamaged"]
117 [-]: GETTABLE  R14 R14 R8   ; R14 := R14[R8]
118 [-]: LT        0 K10 R14    ; if 0 >= R14 then PC := 156
119 [-]: JMP       156          ; PC := 156
120 [-]: LOADK     R14 K37      ; R14 := 1
121 [-]: GETGLOBAL R15 K35      ; R15 := _T
122 [-]: GETTABLE  R15 R15 K36  ; R15 := R15["voidFirewallDamaged"]
...
128 [-]: JMP       130          ; PC := 130
129 [-]: JMP       153          ; PC := 153
130 [-]: SELF      R18 R7 K38   ; R19 := R7; R18 := R7["0xF21555A7"]
131 [-]: GETGLOBAL R20 K17      ; R20 := Game
132 [-]: GETTABLE  R20 R20 K18  ; R20 := R20["AVATAR_DAMAGE_RESISTANCE"]
133 [-]: GETGLOBAL R21 K19      ; R21 := Engine
134 [-]: GETTABLE  R21 R21 K20  ; R21 := R21["ADD"]
135 [-]: GETUPVAL  R22 U1       ; R22 := U1
136 [-]: CALL      R18 5 1      ; R18(R19,R20,R21,R22)
137 [-]: GETGLOBAL R18 K11      ; R18 := 0x400E7765
138 [-]: GETTABLE  R19 R9 K37   ; R19 := R9[1]
139 [-]: GETTABLE  R19 R19 K30  ; R19 := R19["effect"]
140 [-]: CALL      R18 2 2      ; R18 := R18(R19)
141 [-]: TEST      R18 1        ; if R18 then PC := 147
142 [-]: JMP       147          ; PC := 147
143 [-]: GETTABLE  R18 R9 K37   ; R18 := R9[1]
144 [-]: GETTABLE  R18 R18 K30  ; R18 := R18["effect"]
145 [-]: SELF      R18 R18 K39  ; R19 := R18; R18 := R18["0xD4C2743F"]
146 [-]: CALL      R18 2 1      ; R18(R19)
147 [-]: GETGLOBAL R18 K31      ; R18 := table
148 [-]: GETTABLE  R18 R18 K40  ; R18 := R18["0xCDB1FD5E"]
149 [-]: MOVE      R19 R9       ; R19 := R9
150 [-]: LOADK     R20 K37      ; R20 := 1
...
154 [-]: GETTABLE  R18 R18 K36  ; R18 := R18["voidFirewallDamaged"]
155 [-]: SETTABLE  R18 R8 K10   ; R18[R8] := 0
156 [-]: LEN       R18 R9       ; R18 := # R9
157 [-]: LOADK     R19 K37      ; R19 := 1
...
180 [-]: GETTABLE  R23 R23 K30  ; R23 := R23["effect"]
181 [-]: CALL      R22 2 2      ; R22 := R22(R23)
182 [-]: TEST      R22 1        ; if R22 then PC := 188
183 [-]: JMP       188          ; PC := 188
184 [-]: GETTABLE  R22 R9 R21   ; R22 := R9[R21]
185 [-]: GETTABLE  R22 R22 K30  ; R22 := R22["effect"]
186 [-]: SELF      R22 R22 K39  ; R23 := R22; R22 := R22["0xD4C2743F"]
187 [-]: CALL      R22 2 1      ; R22(R23)
188 [-]: GETGLOBAL R22 K31      ; R22 := table
189 [-]: GETTABLE  R22 R22 K40  ; R22 := R22["0xCDB1FD5E"]
...
194 [-]: GETGLOBAL R22 K42      ; R22 := 0x201191EA
