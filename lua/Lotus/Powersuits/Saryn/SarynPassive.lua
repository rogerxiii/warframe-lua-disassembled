...
; Command line was: -dis M:\git repos\warframe-lua-disassembled\lua\Lotus\Powersuits\Saryn\SarynPassive.luac 
...
; Max Stack Size:  7
 ...
 23 [-]: GETTABLE  R4 R4 K8     ; R4 := R4["WEAPON_PROC_TIME"]
 24 [-]: GETGLOBAL R5 K9        ; R5 := Engine
 25 [-]: GETTABLE  R5 R5 K10    ; R5 := R5["STACKING_MULTIPLY"]
