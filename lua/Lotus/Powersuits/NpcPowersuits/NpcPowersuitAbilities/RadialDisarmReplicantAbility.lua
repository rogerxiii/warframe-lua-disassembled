...
; Max Stack Size:  17
 ...
 34 [-]: SETGLOBAL R11 K9       ; GetAbilityUpgradeLevelInfo := R11
 35 [-]: SETGLOBAL R11 K10      ; 0x4284ECE5 := R11
 ...
 44 [-]: MOVE      R0 R8        ; R0 := R8
 45 [-]: SETGLOBAL R12 K13      ; NpcEvaluateAbility := R12
 46 [-]: SETGLOBAL R12 K14      ; 0xECF1EA57 := R12
 47 [-]: CLOSURE   R12 6        ; R12 := closure(Function #7)
 48 [-]: SETGLOBAL R12 K15      ; EvaluateAbility := R12
 49 [-]: SETGLOBAL R12 K16      ; 0x87647B87 := R12
 50 [-]: CLOSURE   R12 7        ; R12 := closure(Function #8)
 51 [-]: MOVE      R0 R1        ; R0 := R1
 52 [-]: SETGLOBAL R12 K17      ; InitializeAbility := R12
 53 [-]: SETGLOBAL R12 K18      ; 0x3BDC280E := R12
 54 [-]: LOADK     R12 K19      ; R12 := 0
 55 [-]: GETGLOBAL R13 K6       ; R13 := 0xEC274B1A
 56 [-]: LOADK     R14 K20      ; R14 := "RadialDisarmAug"
 57 [-]: CALL      R13 2 2      ; R13 := R13(R14)
 58 [-]: CLOSURE   R14 8        ; R14 := closure(Function #9)
 59 [-]: MOVE      R0 R13       ; R0 := R13
 60 [-]: MOVE      R0 R12       ; R0 := R12
 61 [-]: SETGLOBAL R14 K21      ; DoAugmentOne := R14
 62 [-]: SETGLOBAL R14 K22      ; 0x15B4C328 := R14
 ...
 71 [-]: MOVE      R0 R8        ; R0 := R8
 72 [-]: MOVE      R0 R1        ; R0 := R1
 73 [-]: SETGLOBAL R14 K23      ; ActivateAbility := R14
 74 [-]: SETGLOBAL R14 K24      ; 0xCC0B19E0 := R14
 75 [-]: CLOSURE   R14 10       ; R14 := closure(Function #11)
 76 [-]: MOVE      R0 R10       ; R0 := R10
 77 [-]: SETGLOBAL R14 K7       ; ForceNpcMeleeOnly := R14
 78 [-]: SETGLOBAL R14 K25      ; 0x7312E8A4 := R14
 ...
 84 [-]: SETGLOBAL R16 K26      ; DisarmPlayer := R16
 85 [-]: SETGLOBAL R16 K27      ; 0x3760CE90 := R16
 86 [-]: CLOSURE   R16 12       ; R16 := closure(Function #13)
 87 [-]: MOVE      R0 R14       ; R0 := R14
 88 [-]: MOVE      R0 R15       ; R0 := R15
 89 [-]: SETGLOBAL R16 K28      ; DisablePlayers := R16
 90 [-]: SETGLOBAL R16 K29      ; 0x25F34A68 := R16
