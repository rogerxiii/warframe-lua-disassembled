...
; Command line was: -dis M:\git repos\warframe-lua-disassembled\B.Font.cache_extracted\Lotus\Powersuits\NpcPowersuits\NpcPowersuitAbilities\AmalgamSatyrMissileAbility.luac 
...
; Max Stack Size:  10
 ...
 15 [-]: EQ        1 R3 K4      ; if R3 == 1 then PC := 19
 16 [-]: JMP       19           ; PC := 19
 17 [-]: LOADK     R3 K2        ; R3 := 0
