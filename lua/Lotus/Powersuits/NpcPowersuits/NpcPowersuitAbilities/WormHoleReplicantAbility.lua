...
; Command line was: -dis M:\git repos\warframe-lua-disassembled\B.Font.cache_extracted\Lotus\Powersuits\NpcPowersuits\NpcPowersuitAbilities\WormHoleReplicantAbility.luac 
...
; Max Stack Size:  17
 ...
 25 [-]: MOVE      R0 R1        ; R0 := R1
 26 [-]: MOVE      R0 R2        ; R0 := R2
 27 [-]: SETGLOBAL R10 K8       ; GetAbilityUpgradeLevelInfo := R10
 28 [-]: SETGLOBAL R10 K9       ; 0x4284ECE5 := R10
 ...
 34 [-]: MOVE      R0 R5        ; R0 := R5
 35 [-]: MOVE      R0 R6        ; R0 := R6
 36 [-]: SETGLOBAL R11 K10      ; GetAugmentDescriptionInfo := R11
 37 [-]: SETGLOBAL R11 K11      ; 0xB6A3C9C2 := R11
 38 [-]: CLOSURE   R11 5        ; R11 := closure(Function #6)
 39 [-]: CLOSURE   R12 6        ; R12 := closure(Function #7)
 40 [-]: CLOSURE   R13 7        ; R13 := closure(Function #8)
 41 [-]: SETGLOBAL R13 K12      ; NpcEvaluateAbility := R13
 42 [-]: SETGLOBAL R13 K13      ; 0xECF1EA57 := R13
 43 [-]: CLOSURE   R13 8        ; R13 := closure(Function #9)
 44 [-]: MOVE      R0 R4        ; R0 := R4
 45 [-]: SETGLOBAL R13 K14      ; InitializeAbility := R13
 46 [-]: SETGLOBAL R13 K15      ; 0x3BDC280E := R13
 47 [-]: CLOSURE   R13 9        ; R13 := closure(Function #10)
 48 [-]: MOVE      R0 R11       ; R0 := R11
 49 [-]: MOVE      R0 R8        ; R0 := R8
 50 [-]: MOVE      R0 R9        ; R0 := R9
 51 [-]: MOVE      R0 R12       ; R0 := R12
 52 [-]: SETGLOBAL R13 K16      ; ActivateAbility := R13
 53 [-]: SETGLOBAL R13 K17      ; 0xCC0B19E0 := R13
 54 [-]: CLOSURE   R13 10       ; R13 := closure(Function #11)
 55 [-]: SETGLOBAL R13 K18      ; DeactivateAbility := R13
 56 [-]: SETGLOBAL R13 K19      ; 0x1FDB8A0 := R13
 57 [-]: CLOSURE   R13 11       ; R13 := closure(Function #12)
 58 [-]: SETGLOBAL R13 K20      ; CreatePortal := R13
 59 [-]: SETGLOBAL R13 K21      ; 0x14D4E6F6 := R13
 60 [-]: CLOSURE   R13 12       ; R13 := closure(Function #13)
 61 [-]: MOVE      R0 R7        ; R0 := R7
 62 [-]: MOVE      R0 R8        ; R0 := R8
 63 [-]: MOVE      R0 R1        ; R0 := R1
 64 [-]: MOVE      R0 R9        ; R0 := R9
 65 [-]: MOVE      R0 R2        ; R0 := R2
 66 [-]: SETGLOBAL R13 K22      ; Deploy := R13
 67 [-]: SETGLOBAL R13 K23      ; 0xBF02B581 := R13
 68 [-]: CLOSURE   R13 13       ; R13 := closure(Function #14)
 69 [-]: CLOSURE   R14 14       ; R14 := closure(Function #15)
 70 [-]: SETGLOBAL R14 K24      ; OnTeleport := R14
 71 [-]: SETGLOBAL R14 K25      ; 0x669562FA := R14
 72 [-]: CLOSURE   R14 15       ; R14 := closure(Function #16)
 73 [-]: NEWTABLE  R15 0 2      ; R15 := {}
 74 [-]: SETTABLE  R15 K26 K27  ; R15["instigatorAvatar"] := nil
 75 [-]: SETTABLE  R15 K28 K27  ; R15["instigatorSuit"] := nil
 76 [-]: CLOSURE   R16 16       ; R16 := closure(Function #17)
 77 [-]: MOVE      R0 R5        ; R0 := R5
 78 [-]: MOVE      R0 R15       ; R0 := R15
 79 [-]: MOVE      R0 R7        ; R0 := R7
 80 [-]: MOVE      R0 R6        ; R0 := R6
 81 [-]: SETGLOBAL R16 K29      ; AugmentOne := R16
 82 [-]: SETGLOBAL R16 K30      ; 0xF3AC7F64 := R16
 ...
 90 [-]: SETGLOBAL R16 K31      ; wormHole := R16
 91 [-]: SETGLOBAL R16 K32      ; 0xC22A428A := R16
...
; Max Stack Size:  14
 ...
 28 [-]: SELF      R7 R4 K8     ; R8 := R4; R7 := R4["0x896389C9"]
 29 [-]: CALL      R7 2 2       ; R7 := R7(R8)
 30 [-]: TEST      R7 1         ; if R7 then PC := 57
 31 [-]: JMP       57           ; PC := 57
 32 [-]: SELF      R7 R4 K9     ; R8 := R4; R7 := R4["0xABD9DD93"]
 33 [-]: CALL      R7 2 2       ; R7 := R7(R8)
 34 [-]: GETGLOBAL R8 K6        ; R8 := 0x400E7765
 35 [-]: MOVE      R9 R7        ; R9 := R7
 36 [-]: CALL      R8 2 2       ; R8 := R8(R9)
 37 [-]: TEST      R8 1         ; if R8 then PC := 57
 38 [-]: JMP       57           ; PC := 57
 39 [-]: SELF      R8 R7 K10    ; R9 := R7; R8 := R7["0xE5E996"]
 40 [-]: SUB       R10 R3 R2    ; R10 := R3 - R2
 41 [-]: MUL       R10 R10 K11  ; R10 := R10 * 0.050000000745058
 ...
 47 [-]: GETGLOBAL R8 K12       ; R8 := 0x201191EA
 48 [-]: LOADK     R9 K13       ; R9 := 1.5
 49 [-]: CALL      R8 2 1       ; R8(R9)
 50 [-]: GETGLOBAL R8 K6        ; R8 := 0x400E7765
 51 [-]: MOVE      R9 R7        ; R9 := R7
 52 [-]: CALL      R8 2 2       ; R8 := R8(R9)
 53 [-]: TEST      R8 1         ; if R8 then PC := 57
 54 [-]: JMP       57           ; PC := 57
 55 [-]: SELF      R8 R7 K14    ; R9 := R7; R8 := R7["0x750771BC"]
...
; Max Stack Size:  13
  ...
  4 [-]: GETGLOBAL R4 K1        ; R4 := 0x221C9700
  5 [-]: CALL      R4 1 2       ; R4 := R4()
  6 [-]: GETGLOBAL R5 K1        ; R5 := 0x221C9700
  7 [-]: GETTABLE  R6 R1 K2     ; R6 := R1["x"]
  8 [-]: GETTABLE  R7 R1 K3     ; R7 := R1["y"]
  9 [-]: SUB       R7 R7 K4     ; R7 := R7 - 125
 10 [-]: GETTABLE  R8 R1 K5     ; R8 := R1["z"]
 11 [-]: CALL      R5 4 2       ; R5 := R5(R6,R7,R8)
 12 [-]: GETGLOBAL R6 K6        ; R6 := gRegion
 13 [-]: SELF      R6 R6 K7     ; R7 := R6; R6 := R6["0xB29B96B"]
 14 [-]: MOVE      R8 R1        ; R8 := R1
 15 [-]: MOVE      R9 R5        ; R9 := R5
 ...
 24 [-]: SELF      R6 R2 K8     ; R7 := R2; R6 := R2["0x8358B3C7"]
 25 [-]: MOVE      R8 R1        ; R8 := R1
...
; Max Stack Size:  40
  ...
  3 [-]: CALL      R1 2 2       ; R1 := R1(R2)
  4 [-]: TEST      R1 0         ; if not R1 then PC := 356
  5 [-]: JMP       356          ; PC := 356
...
283 [-]: TEST      R11 0        ; if not R11 then PC := 356
284 [-]: JMP       356          ; PC := 356
...
317 [-]: TEST      R32 1        ; if R32 then PC := 356
318 [-]: JMP       356          ; PC := 356
...
325 [-]: LT        0 K4 R32     ; if 0 >= R32 then PC := 356
326 [-]: JMP       356          ; PC := 356
327 [-]: GETGLOBAL R34 K20      ; R34 := Lotus_Game
328 [-]: GETTABLE  R34 R34 K63  ; R34 := R34["PowerSuit_AUGMENT_ONE"]
329 [-]: EQ        0 R33 R34    ; if R33 ~= R34 then PC := 356
330 [-]: JMP       356          ; PC := 356
331 [-]: GETUPVAL  R34 U3       ; R34 := U3
332 [-]: MOVE      R35 R32      ; R35 := R32
333 [-]: MOVE      R36 R33      ; R36 := R33
334 [-]: CALL      R34 3 1      ; R34(R35,R36)
335 [-]: SELF      R34 R4 K25   ; R35 := R4; R34 := R4["0x8DB5D01F"]
336 [-]: CALL      R34 2 2      ; R34 := R34(R35)
337 [-]: SELF      R34 R34 K64  ; R35 := R34; R34 := R34["0xC7EA8CA1"]
338 [-]: GETUPVAL  R36 U4       ; R36 := U4
339 [-]: GETGLOBAL R37 K65      ; R37 := Game
340 [-]: GETTABLE  R37 R37 K66  ; R37 := R37["AVATAR_ABILITY_DURATION"]
341 [-]: SELF      R38 R31 K67  ; R39 := R31; R38 := R31["0xE2B32C65"]
342 [-]: CALL      R38 2 2      ; R38 := R38(R39)
343 [-]: MOVE      R39 R31      ; R39 := R31
344 [-]: CALL      R34 6 2      ; R34 := R34(R35,R36,R37,R38,R39)
345 [-]: MOVE      R34 R4       ; R34 := R4
346 [-]: GETUPVAL  R34 U5       ; R34 := U5
347 [-]: SETTABLE  R34 K68 R4   ; R34["instigatorAvatar"] := R4
348 [-]: GETUPVAL  R34 U5       ; R34 := U5
349 [-]: SETTABLE  R34 K69 R31  ; R34["instigatorSuit"] := R31
350 [-]: SELF      R34 R1 K70   ; R35 := R1; R34 := R1["0xB26452A2"]
351 [-]: GETGLOBAL R36 K71      ; R36 := 0xEC274B1A
352 [-]: LOADK     R37 K72      ; R37 := "AugmentOne"
353 [-]: CALL      R36 2 2      ; R36 := R36(R37)
354 [-]: MOVE      R37 R0       ; R37 := R0
