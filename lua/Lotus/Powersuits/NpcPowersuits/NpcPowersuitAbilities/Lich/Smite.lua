...
; Command line was: -dis M:\git repos\warframe-lua-disassembled\B.Font.cache_extracted\Lotus\Powersuits\NpcPowersuits\NpcPowersuitAbilities\Lich\Smite.luac 
...
; Max Stack Size:  2
 ...
 12 [-]: LOADK     R1 K4        ; R1 := 5
 13 [-]: MOVE      R1 R3        ; R1 := R3
 14 [-]: LOADK     R1 K5        ; R1 := 250
 15 [-]: MOVE      R1 R4        ; R1 := R4
 16 [-]: LOADK     R1 K6        ; R1 := 200
 17 [-]: MOVE      R1 R5        ; R1 := R5
 18 [-]: LOADK     R1 K7        ; R1 := 0.15000000596046
 19 [-]: MOVE      R1 R6        ; R1 := R6
 20 [-]: JMP       35           ; PC := 35
 21 [-]: EQ        0 R0 K8      ; if R0 ~= 2 then PC := 35
 22 [-]: JMP       35           ; PC := 35
 ...
 28 [-]: MOVE      R1 R3        ; R1 := R3
 29 [-]: LOADK     R1 K12       ; R1 := 350
 30 [-]: MOVE      R1 R4        ; R1 := R4
 31 [-]: LOADK     R1 K5        ; R1 := 250
 32 [-]: MOVE      R1 R5        ; R1 := R5
...
; Max Stack Size:  56
 ...
 49 [-]: GETTABLE  R15 R15 K14  ; R15 := R15["0x38BF6E8B"]
 50 [-]: MOVE      R16 R0       ; R16 := R0
 51 [-]: GETGLOBAL R17 K15      ; R17 := activateAnim
 52 [-]: LOADK     R18 K16      ; R18 := "Fire"
