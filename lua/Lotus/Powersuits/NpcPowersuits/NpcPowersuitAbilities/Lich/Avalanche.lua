...
; Command line was: -dis M:\git repos\warframe-lua-disassembled\B.Font.cache_extracted\Lotus\Powersuits\NpcPowersuits\NpcPowersuitAbilities\Lich\Avalanche.luac 
...
; Max Stack Size:  25
 ...
 91 [-]: SETGLOBAL R21 K25      ; GetAbilityUpgradeLevelInfo := R21
 92 [-]: SETGLOBAL R21 K26      ; 0x4284ECE5 := R21
 93 [-]: CLOSURE   R21 3        ; R21 := closure(Function #4)
 94 [-]: MOVE      R0 R13       ; R0 := R13
 95 [-]: MOVE      R0 R16       ; R0 := R16
 96 [-]: CLOSURE   R22 4        ; R22 := closure(Function #5)
 97 [-]: MOVE      R0 R21       ; R0 := R21
 98 [-]: MOVE      R0 R16       ; R0 := R16
 99 [-]: SETGLOBAL R22 K27      ; GetAugmentDescriptionInfo := R22
100 [-]: SETGLOBAL R22 K28      ; 0xB6A3C9C2 := R22
101 [-]: CLOSURE   R22 5        ; R22 := closure(Function #6)
102 [-]: MOVE      R0 R12       ; R0 := R12
103 [-]: CLOSURE   R23 6        ; R23 := closure(Function #7)
104 [-]: MOVE      R0 R13       ; R0 := R13
105 [-]: MOVE      R0 R3        ; R0 := R3
106 [-]: SETGLOBAL R23 K29      ; ChildApplyFrozen := R23
107 [-]: SETGLOBAL R23 K30      ; 0xDBFE334F := R23
108 [-]: CLOSURE   R23 7        ; R23 := closure(Function #8)
109 [-]: SETGLOBAL R23 K31      ; EvaluateAbility := R23
110 [-]: SETGLOBAL R23 K32      ; 0x87647B87 := R23
111 [-]: CLOSURE   R23 8        ; R23 := closure(Function #9)
112 [-]: CLOSURE   R24 9        ; R24 := closure(Function #10)
113 [-]: MOVE      R0 R18       ; R0 := R18
114 [-]: SETGLOBAL R24 K33      ; NpcEvaluateAbility := R24
115 [-]: SETGLOBAL R24 K34      ; 0xECF1EA57 := R24
116 [-]: CLOSURE   R24 10       ; R24 := closure(Function #11)
117 [-]: MOVE      R0 R13       ; R0 := R13
118 [-]: SETGLOBAL R24 K35      ; InitializeAbility := R24
119 [-]: SETGLOBAL R24 K36      ; 0x3BDC280E := R24
120 [-]: CLOSURE   R24 11       ; R24 := closure(Function #12)
...
142 [-]: SETGLOBAL R24 K37      ; ActivateAbility := R24
143 [-]: SETGLOBAL R24 K38      ; 0xCC0B19E0 := R24
144 [-]: CLOSURE   R24 12       ; R24 := closure(Function #13)
145 [-]: SETGLOBAL R24 K39      ; SpikeDecoScalar := R24
146 [-]: SETGLOBAL R24 K40      ; 0x73486BF2 := R24
147 [-]: CLOSURE   R24 13       ; R24 := closure(Function #14)
148 [-]: MOVE      R0 R17       ; R0 := R17
149 [-]: MOVE      R0 R8        ; R0 := R8
150 [-]: MOVE      R0 R4        ; R0 := R4
151 [-]: MOVE      R0 R6        ; R0 := R6
152 [-]: MOVE      R0 R5        ; R0 := R5
153 [-]: SETGLOBAL R24 K41      ; FrozenLoop := R24
154 [-]: SETGLOBAL R24 K42      ; 0x43AE1ECB := R24
155 [-]: CLOSURE   R24 14       ; R24 := closure(Function #15)
156 [-]: MOVE      R0 R8        ; R0 := R8
157 [-]: SETGLOBAL R24 K43      ; AugmentLoop := R24
158 [-]: SETGLOBAL R24 K44      ; 0xD5D3C963 := R24
...
; Max Stack Size:  2
  ...
  3 [-]: LOADK     R1 K1        ; R1 := 20
  4 [-]: MOVE      R1 R0        ; R1 := R0
  5 [-]: LOADK     R1 K2        ; R1 := 125
  6 [-]: MOVE      R1 R1        ; R1 := R1
  7 [-]: LOADK     R1 K3        ; R1 := 2
  8 [-]: MOVE      R1 R2        ; R1 := R2
  9 [-]: LOADK     R1 K0        ; R1 := 1
 10 [-]: MOVE      R1 R3        ; R1 := R3
 11 [-]: LOADK     R1 K4        ; R1 := 3.5
 12 [-]: MOVE      R1 R4        ; R1 := R4
 13 [-]: LOADK     R1 K5        ; R1 := 100
 14 [-]: MOVE      R1 R5        ; R1 := R5
 15 [-]: JMP       30           ; PC := 30
 16 [-]: EQ        0 R0 K3      ; if R0 ~= 2 then PC := 30
 17 [-]: JMP       30           ; PC := 30
 18 [-]: LOADK     R1 K6        ; R1 := 25
 19 [-]: MOVE      R1 R0        ; R1 := R0
 20 [-]: LOADK     R1 K7        ; R1 := 300
 21 [-]: MOVE      R1 R1        ; R1 := R1
 22 [-]: LOADK     R1 K4        ; R1 := 3.5
 23 [-]: MOVE      R1 R2        ; R1 := R2
 24 [-]: LOADK     R1 K0        ; R1 := 1
 25 [-]: MOVE      R1 R3        ; R1 := R3
 26 [-]: LOADK     R1 K4        ; R1 := 3.5
 27 [-]: MOVE      R1 R4        ; R1 := R4
 28 [-]: LOADK     R1 K5        ; R1 := 100
 29 [-]: MOVE      R1 R5        ; R1 := R5
...
; Max Stack Size:  7
 ...
 36 [-]: SETTABLE  R3 K10 K11   ; R3["Label"] := "/Game/WEAPON_DAMAGE_AMOUNT"
 ...
 45 [-]: SETTABLE  R3 K10 K11   ; R3["Label"] := "/Game/WEAPON_DAMAGE_AMOUNT"
 ...
 71 [-]: SETTABLE  R3 K10 K18   ; R3["Label"] := "/Game/WEAPON_MELEE_ARMOR_REDUCTION"
