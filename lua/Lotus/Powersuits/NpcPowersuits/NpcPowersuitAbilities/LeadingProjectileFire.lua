...
; Command line was: -dis M:\git repos\warframe-lua-disassembled\B.Font.cache_extracted\Lotus\Powersuits\NpcPowersuits\NpcPowersuitAbilities\LeadingProjectileFire.luac 
...
; Max Stack Size:  9
 ...
 39 [-]: JMP       43           ; PC := 43
 40 [-]: SELF      R6 R4 K11    ; R7 := R4; R6 := R4["0x8A8A289A"]
 41 [-]: MOVE      R8 R5        ; R8 := R5
...
; Max Stack Size:  14
 ...
 10 [-]: TEST      R5 1         ; if R5 then PC := 69
 11 [-]: JMP       69           ; PC := 69
 12 [-]: SELF      R5 R1 K2     ; R6 := R1; R5 := R1["0x6DA72501"]
 13 [-]: CALL      R5 2 2       ; R5 := R5(R6)
 14 [-]: MOVE      R4 R5        ; R4 := R5
 15 [-]: EQ        0 R4 K4      ; if R4 ~= nil then PC := 18
 16 [-]: JMP       18           ; PC := 18
 17 [-]: RETURN    R0 1         ; return 
 18 [-]: GETGLOBAL R5 K5        ; R5 := 0x8C4A6742
 19 [-]: GETGLOBAL R6 K6        ; R6 := angleVariation
 20 [-]: UNM       R6 R6        ; R6 := - R6
 21 [-]: GETGLOBAL R7 K6        ; R7 := angleVariation
 22 [-]: CALL      R5 3 2       ; R5 := R5(R6,R7)
 23 [-]: GETGLOBAL R6 K7        ; R6 := 0x4CBE9A09
 24 [-]: SELF      R7 R1 K8     ; R8 := R1; R7 := R1["0xE0C9C9E0"]
 ...
 32 [-]: GETGLOBAL R7 K11       ; R7 := targetVelocityMult
 33 [-]: MUL       R6 R6 R7     ; R6 := R6 * R7
 34 [-]: GETGLOBAL R7 K7        ; R7 := 0x4CBE9A09
 35 [-]: SELF      R8 R1 K12    ; R9 := R1; R8 := R1["0xEA33AF61"]
 36 [-]: CALL      R8 2 2       ; R8 := R8(R9)
 37 [-]: GETGLOBAL R9 K9        ; R9 := 0x1E4F6281
 38 [-]: MOVE      R10 R5       ; R10 := R5
 39 [-]: LOADK     R11 K10      ; R11 := 0
 40 [-]: LOADK     R12 K10      ; R12 := 0
 41 [-]: CALL      R9 4 0       ; R9,... := R9(R10,R11,R12)
 42 [-]: CALL      R7 0 2       ; R7 := R7(R8,...)
 43 [-]: GETGLOBAL R8 K13       ; R8 := offsetFromTargetFacing
 44 [-]: MUL       R7 R7 R8     ; R7 := R7 * R8
 45 [-]: ADD       R8 R4 R6     ; R8 := R4 + R6
 46 [-]: ADD       R8 R8 R7     ; R8 := R8 + R7
 47 [-]: SELF      R9 R2 K14    ; R10 := R2; R9 := R2["0xD74DBB32"]
 48 [-]: MOVE      R11 R8       ; R11 := R8
 49 [-]: LOADK     R12 K15      ; R12 := 10
 50 [-]: LOADK     R13 K10      ; R13 := 0
 51 [-]: CALL      R9 5 2       ; R9 := R9(R10,R11,R12,R13)
 52 [-]: TEST      R9 0         ; if not R9 then PC := 69
 53 [-]: JMP       69           ; PC := 69
 54 [-]: GETUPVAL  R9 U0        ; R9 := U0
 55 [-]: SELF      R10 R0 K2    ; R11 := R0; R10 := R0["0x6DA72501"]
 56 [-]: CALL      R10 2 2      ; R10 := R10(R11)
 57 [-]: MOVE      R11 R8       ; R11 := R8
 58 [-]: MOVE      R12 R0       ; R12 := R0
 59 [-]: CALL      R9 4 1       ; R9(R10,R11,R12)
 60 [-]: GETGLOBAL R9 K3        ; R9 := 0x400E7765
 61 [-]: GETGLOBAL R10 K16      ; R10 := launchSound
 62 [-]: CALL      R9 2 2       ; R9 := R9(R10)
 63 [-]: TEST      R9 1         ; if R9 then PC := 69
 64 [-]: JMP       69           ; PC := 69
 65 [-]: SELF      R9 R0 K17    ; R10 := R0; R9 := R0["0x25992394"]
 66 [-]: GETGLOBAL R11 K16      ; R11 := launchSound
