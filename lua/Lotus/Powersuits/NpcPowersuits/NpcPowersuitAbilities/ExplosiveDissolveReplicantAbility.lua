...
; Command line was: -dis M:\git repos\warframe-lua-disassembled\B.Font.cache_extracted\Lotus\Powersuits\NpcPowersuits\NpcPowersuitAbilities\ExplosiveDissolveReplicantAbility.luac 
...
; Max Stack Size:  9
 ...
 25 [-]: MOVE      R0 R4        ; R0 := R4
 26 [-]: MOVE      R0 R7        ; R0 := R7
 27 [-]: SETGLOBAL R8 K9        ; GetAbilityUpgradeLevelInfo := R8
 28 [-]: SETGLOBAL R8 K10       ; 0x4284ECE5 := R8
 29 [-]: CLOSURE   R8 3         ; R8 := closure(Function #4)
 30 [-]: MOVE      R0 R5        ; R0 := R5
 31 [-]: SETGLOBAL R8 K11       ; NpcEvaluateAbility := R8
 32 [-]: SETGLOBAL R8 K12       ; 0xECF1EA57 := R8
 33 [-]: CLOSURE   R8 4         ; R8 := closure(Function #5)
 34 [-]: MOVE      R0 R0        ; R0 := R0
 35 [-]: SETGLOBAL R8 K13       ; InitializeAbility := R8
 36 [-]: SETGLOBAL R8 K14       ; 0x3BDC280E := R8
 ...
 43 [-]: MOVE      R0 R5        ; R0 := R5
 44 [-]: MOVE      R0 R0        ; R0 := R0
 45 [-]: SETGLOBAL R8 K15       ; ActivateAbility := R8
 46 [-]: SETGLOBAL R8 K16       ; 0xCC0B19E0 := R8
 ...
 51 [-]: MOVE      R0 R1        ; R0 := R1
 52 [-]: MOVE      R0 R0        ; R0 := R0
 53 [-]: SETGLOBAL R8 K17       ; Dissolve := R8
 54 [-]: SETGLOBAL R8 K18       ; 0xE2AE63D1 := R8
