...
; Max Stack Size:  20
 ...
 54 [-]: SETGLOBAL R16 K19      ; GetAbilityUpgradeLevelInfo := R16
 55 [-]: SETGLOBAL R16 K20      ; 0x4284ECE5 := R16
 56 [-]: CLOSURE   R16 5        ; R16 := closure(Function #6)
 57 [-]: MOVE      R0 R14       ; R0 := R14
 58 [-]: MOVE      R0 R11       ; R0 := R11
 59 [-]: SETGLOBAL R16 K21      ; GetAugmentDescriptionInfo := R16
 60 [-]: SETGLOBAL R16 K22      ; 0xB6A3C9C2 := R16
 61 [-]: CLOSURE   R16 6        ; R16 := closure(Function #7)
 62 [-]: MOVE      R0 R3        ; R0 := R3
 63 [-]: MOVE      R0 R5        ; R0 := R5
 64 [-]: SETGLOBAL R16 K23      ; InitializeAbility := R16
 65 [-]: SETGLOBAL R16 K24      ; 0x3BDC280E := R16
 66 [-]: CLOSURE   R16 7        ; R16 := closure(Function #8)
 67 [-]: MOVE      R0 R1        ; R0 := R1
 68 [-]: SETGLOBAL R16 K25      ; EvaluateAbility := R16
 69 [-]: SETGLOBAL R16 K26      ; 0x87647B87 := R16
 70 [-]: CLOSURE   R16 8        ; R16 := closure(Function #9)
 71 [-]: SETGLOBAL R16 K27      ; NpcEvaluateAbility := R16
 72 [-]: SETGLOBAL R16 K28      ; 0xECF1EA57 := R16
 73 [-]: CLOSURE   R16 9        ; R16 := closure(Function #10)
 74 [-]: CLOSURE   R17 10       ; R17 := closure(Function #11)
 75 [-]: SETGLOBAL R17 K29      ; YinYangBurstAugmentMorph := R17
 76 [-]: SETGLOBAL R17 K30      ; 0xFE3EB8DB := R17
 77 [-]: CLOSURE   R17 11       ; R17 := closure(Function #12)
 78 [-]: MOVE      R0 R4        ; R0 := R4
 79 [-]: CLOSURE   R18 12       ; R18 := closure(Function #13)
 80 [-]: MOVE      R0 R4        ; R0 := R4
 81 [-]: MOVE      R0 R1        ; R0 := R1
 ...
 98 [-]: SETGLOBAL R19 K31      ; ActivateAbility := R19
 99 [-]: SETGLOBAL R19 K32      ; 0xCC0B19E0 := R19
100 [-]: CLOSURE   R19 14       ; R19 := closure(Function #15)
...
109 [-]: SETGLOBAL R19 K33      ; DeactivateAbility := R19
110 [-]: SETGLOBAL R19 K34      ; 0x1FDB8A0 := R19
