...
; Max Stack Size:  28
 ...
 95 [-]: GETGLOBAL R22 K29      ; R22 := Engine
 96 [-]: GETTABLE  R22 R22 K30  ; R22 := R22["STACKING_MULTIPLY"]
...
102 [-]: GETTABLE  R21 R21 K31  ; R21 := R21["AVATAR_PARKOUR_BOOST"]
103 [-]: GETGLOBAL R22 K29      ; R22 := Engine
104 [-]: GETTABLE  R22 R22 K30  ; R22 := R22["STACKING_MULTIPLY"]
...
110 [-]: GETTABLE  R21 R21 K32  ; R21 := R21["AVATAR_INJURY_BLOCK_CHANCE"]
111 [-]: GETGLOBAL R22 K29      ; R22 := Engine
112 [-]: GETTABLE  R22 R22 K33  ; R22 := R22["ADD"]
113 [-]: GETUPVAL  R23 U7       ; R23 := U7
114 [-]: LOADNIL   R24 R25      ; R24 := R25 := nil
115 [-]: GETGLOBAL R26 K29      ; R26 := Engine
...
166 [-]: GETGLOBAL R34 K51      ; R34 := Engine
167 [-]: GETTABLE  R34 R34 K52  ; R34 := R34["ADD"]
...
174 [-]: JMP       178          ; PC := 178
175 [-]: SELF      R29 R24 K53  ; R30 := R24; R29 := R24["0x8938B1C9"]
176 [-]: MOVE      R31 R23      ; R31 := R23
177 [-]: CALL      R29 3 1      ; R29(R30,R31)
178 [-]: SELF      R29 R20 K54  ; R30 := R20; R29 := R20["0x76C229EF"]
...
185 [-]: SELF      R30 R29 K55  ; R31 := R29; R30 := R29["0x4685E6C3"]
186 [-]: GETUPVAL  R32 U4       ; R32 := U4
187 [-]: GETGLOBAL R33 K49      ; R33 := Game
188 [-]: GETTABLE  R33 R33 K56  ; R33 := R33["WEAPON_DAMAGE_AMOUNT"]
189 [-]: GETGLOBAL R34 K51      ; R34 := Engine
190 [-]: GETTABLE  R34 R34 K57  ; R34 := R34["STACKING_MULTIPLY"]
191 [-]: GETUPVAL  R35 U5       ; R35 := U5
192 [-]: CALL      R30 6 1      ; R30(R31,R32,R33,R34,R35)
193 [-]: SELF      R30 R29 K55  ; R31 := R29; R30 := R29["0x4685E6C3"]
194 [-]: GETUPVAL  R32 U6       ; R32 := U6
195 [-]: GETGLOBAL R33 K49      ; R33 := Game
196 [-]: GETTABLE  R33 R33 K58  ; R33 := R33["AVATAR_PARKOUR_BOOST"]
197 [-]: GETGLOBAL R34 K51      ; R34 := Engine
198 [-]: GETTABLE  R34 R34 K57  ; R34 := R34["STACKING_MULTIPLY"]
199 [-]: GETUPVAL  R35 U7       ; R35 := U7
200 [-]: CALL      R30 6 1      ; R30(R31,R32,R33,R34,R35)
201 [-]: SELF      R30 R29 K55  ; R31 := R29; R30 := R29["0x4685E6C3"]
202 [-]: GETUPVAL  R32 U8       ; R32 := U8
203 [-]: GETGLOBAL R33 K49      ; R33 := Game
204 [-]: GETTABLE  R33 R33 K59  ; R33 := R33["AVATAR_INJURY_BLOCK_CHANCE"]
205 [-]: GETGLOBAL R34 K51      ; R34 := Engine
206 [-]: GETTABLE  R34 R34 K52  ; R34 := R34["ADD"]
207 [-]: GETUPVAL  R35 U9       ; R35 := U9
208 [-]: LOADNIL   R36 R37      ; R36 := R37 := nil
209 [-]: GETGLOBAL R38 K51      ; R38 := Engine
...
229 [-]: GETGLOBAL R34 K51      ; R34 := Engine
230 [-]: GETTABLE  R34 R34 K60  ; R34 := R34["DT_ANY"]
231 [-]: GETGLOBAL R35 K51      ; R35 := Engine
232 [-]: GETTABLE  R35 R35 K62  ; R35 := R35["ANY_PART"]
233 [-]: GETGLOBAL R36 K51      ; R36 := Engine
...
126 [-]: GETGLOBAL R22 K37      ; R22 := Engine
127 [-]: GETTABLE  R22 R22 K38  ; R22 := R22["STACKING_MULTIPLY"]
...
133 [-]: GETTABLE  R21 R21 K39  ; R21 := R21["AVATAR_PARKOUR_BOOST"]
134 [-]: GETGLOBAL R22 K37      ; R22 := Engine
135 [-]: GETTABLE  R22 R22 K38  ; R22 := R22["STACKING_MULTIPLY"]
...
141 [-]: GETTABLE  R21 R21 K40  ; R21 := R21["AVATAR_INJURY_BLOCK_CHANCE"]
142 [-]: GETGLOBAL R22 K37      ; R22 := Engine
143 [-]: GETTABLE  R22 R22 K41  ; R22 := R22["ADD"]
144 [-]: GETUPVAL  R23 U7       ; R23 := U7
145 [-]: LOADNIL   R24 R25      ; R24 := R25 := nil
146 [-]: GETGLOBAL R26 K35      ; R26 := Game
147 [-]: GETTABLE  R26 R26 K42  ; R26 := R26["PT_ANY"]
148 [-]: MOVE      R27 R8       ; R27 := R8
149 [-]: CALL      R18 10 1     ; R18(R19,R20,R21,R22,R23,R24,R25,R26,R27)
150 [-]: GETGLOBAL R18 K43      ; R18 := table
151 [-]: GETTABLE  R18 R18 K44  ; R18 := R18["0xCDB1FD5E"]
