...
; Command line was: -dis M:\git repos\warframe-lua-disassembled\B.Font.cache_extracted\Lotus\Powersuits\PowersuitAbilities\BallisticBattery.luac 
...
; Max Stack Size:  14
 ...
 39 [-]: SETGLOBAL R13 K11      ; GetAbilityUpgradeLevelInfo := R13
 40 [-]: SETGLOBAL R13 K12      ; 0x4284ECE5 := R13
 41 [-]: CLOSURE   R13 5        ; R13 := closure(Function #6)
 42 [-]: MOVE      R0 R11       ; R0 := R11
 43 [-]: MOVE      R0 R8        ; R0 := R8
 44 [-]: SETGLOBAL R13 K13      ; GetAugmentDescriptionInfo := R13
 45 [-]: SETGLOBAL R13 K14      ; 0xB6A3C9C2 := R13
 46 [-]: CLOSURE   R13 6        ; R13 := closure(Function #7)
 47 [-]: SETGLOBAL R13 K15      ; NpcEvaluateAbility := R13
 48 [-]: SETGLOBAL R13 K16      ; 0xECF1EA57 := R13
 49 [-]: CLOSURE   R13 7        ; R13 := closure(Function #8)
 50 [-]: MOVE      R0 R1        ; R0 := R1
 51 [-]: SETGLOBAL R13 K17      ; InitializeAbility := R13
 52 [-]: SETGLOBAL R13 K18      ; 0x3BDC280E := R13
 53 [-]: CLOSURE   R13 8        ; R13 := closure(Function #9)
 54 [-]: MOVE      R0 R9        ; R0 := R9
 ...
 60 [-]: MOVE      R0 R5        ; R0 := R5
 61 [-]: MOVE      R0 R2        ; R0 := R2
 62 [-]: SETGLOBAL R13 K19      ; ActivateAbility := R13
 63 [-]: SETGLOBAL R13 K20      ; 0xCC0B19E0 := R13
 ...
 72 [-]: MOVE      R0 R8        ; R0 := R8
 73 [-]: SETGLOBAL R13 K21      ; DeactivateAbility := R13
 74 [-]: SETGLOBAL R13 K22      ; 0x1FDB8A0 := R13
 75 [-]: CLOSURE   R13 10       ; R13 := closure(Function #11)
 76 [-]: MOVE      R0 R2        ; R0 := R2
 77 [-]: MOVE      R0 R4        ; R0 := R4
 78 [-]: SETGLOBAL R13 K23      ; ChargedEffects := R13
 79 [-]: SETGLOBAL R13 K24      ; 0x999BB6EC := R13
 80 [-]: CLOSURE   R13 11       ; R13 := closure(Function #12)
 81 [-]: SETGLOBAL R13 K25      ; DecoFade := R13
 82 [-]: SETGLOBAL R13 K26      ; 0x7F94BC53 := R13
...
; Max Stack Size:  12
 ...
 51 [-]: SETTABLE  R9 K16 K17   ; R9["Label"] := "/Lotus/Language/Suits/BallisticBatteryAbilityAugment1Name"
