...
; Command line was: -dis M:\git repos\warframe-lua-disassembled\lua\Lotus\Powersuits\Trinity\TrinityPassive.luac 
...
; Max Stack Size:  27
 ...
 30 [-]: GETGLOBAL R6 K10       ; R6 := Engine
 31 [-]: GETTABLE  R6 R6 K11    ; R6 := R6["STACKING_MULTIPLY"]
 32 [-]: GETUPVAL  R7 U2        ; R7 := U2
 33 [-]: CALL      R3 5 1       ; R3(R4,R5,R6,R7)
 34 [-]: SELF      R3 R2 K7     ; R4 := R2; R3 := R2["0x3B1B11B9"]
 35 [-]: GETGLOBAL R5 K8        ; R5 := Game
 36 [-]: GETTABLE  R5 R5 K12    ; R5 := R5["AVATAR_REVIVE_DISTANCE"]
 37 [-]: GETGLOBAL R6 K10       ; R6 := Engine
 38 [-]: GETTABLE  R6 R6 K11    ; R6 := R6["STACKING_MULTIPLY"]
 39 [-]: GETUPVAL  R7 U3        ; R7 := U3
 40 [-]: CALL      R3 5 1       ; R3(R4,R5,R6,R7)
 41 [-]: JMP       240          ; PC := 240
 42 [-]: GETGLOBAL R3 K13       ; R3 := _T
 43 [-]: GETTABLE  R3 R3 K14    ; R3 := R3["trinityPassivePvp"]
 44 [-]: EQ        0 R3 K15     ; if R3 ~= nil then PC := 49
 45 [-]: JMP       49           ; PC := 49
 46 [-]: GETGLOBAL R3 K13       ; R3 := _T
 47 [-]: NEWTABLE  R4 0 0       ; R4 := {}
 48 [-]: SETTABLE  R3 K14 R4    ; R3["trinityPassivePvp"] := R4
 49 [-]: SELF      R3 R1 K16    ; R4 := R1; R3 := R1["0xDBEF0FB6"]
 50 [-]: CALL      R3 2 2       ; R3 := R3(R4)
 51 [-]: GETGLOBAL R4 K13       ; R4 := _T
 52 [-]: GETTABLE  R4 R4 K14    ; R4 := R4["trinityPassivePvp"]
 53 [-]: NEWTABLE  R5 0 0       ; R5 := {}
 54 [-]: SETTABLE  R4 R3 R5     ; R4[R3] := R5
 55 [-]: GETGLOBAL R4 K17       ; R4 := Lotus_Game
 56 [-]: GETTABLE  R4 R4 K18    ; R4 := R4["0xFAFD4322"]
 57 [-]: CALL      R4 1 2       ; R4 := R4()
 58 [-]: SETTABLE  R4 K19 R1    ; R4["instigator"] := R1
 59 [-]: GETGLOBAL R5 K21       ; R5 := abilityBuff
 60 [-]: SETTABLE  R4 K20 R5    ; R4["abilityType"] := R5
 61 [-]: GETGLOBAL R5 K17       ; R5 := Lotus_Game
 62 [-]: GETTABLE  R5 R5 K23    ; R5 := R5["BT_PERCENT"]
 63 [-]: SETTABLE  R4 K22 R5    ; R4["buffType"] := R5
 64 [-]: GETUPVAL  R5 U4        ; R5 := U4
 65 [-]: MUL       R5 R5 K25    ; R5 := R5 * 100
 66 [-]: SETTABLE  R4 K24 R5    ; R4["buffData"] := R5
 67 [-]: GETGLOBAL R5 K2        ; R5 := 0x400E7765
 68 [-]: MOVE      R6 R1        ; R6 := R1
 69 [-]: CALL      R5 2 2       ; R5 := R5(R6)
 70 [-]: TEST      R5 1         ; if R5 then PC := 240
 71 [-]: JMP       240          ; PC := 240
 72 [-]: SELF      R5 R1 K26    ; R6 := R1; R5 := R1["0x5A115A02"]
...
130 [-]: GETGLOBAL R16 K13      ; R16 := _T
131 [-]: GETTABLE  R16 R16 K14  ; R16 := R16["trinityPassivePvp"]
132 [-]: GETTABLE  R16 R16 R3   ; R16 := R16[R3]
133 [-]: SETTABLE  R16 R15 K15  ; R16[R15] := nil
134 [-]: TFORLOOP  R10 2        ; R13,R14 :=  R10(R11,R12); if R13 ~= nil then begin PC = 88; R12 := R13 end
135 [-]: JMP       88           ; PC := 88
136 [-]: TEST      R7 0         ; if not R7 then PC := 162
137 [-]: JMP       162          ; PC := 162
138 [-]: GETGLOBAL R16 K13      ; R16 := _T
139 [-]: GETTABLE  R16 R16 K14  ; R16 := R16["trinityPassivePvp"]
140 [-]: GETTABLE  R16 R16 R3   ; R16 := R16[R3]
141 [-]: GETTABLE  R16 R16 R3   ; R16 := R16[R3]
142 [-]: EQ        0 R16 K15    ; if R16 ~= nil then PC := 157
143 [-]: JMP       157          ; PC := 157
144 [-]: SELF      R16 R2 K32   ; R17 := R2; R16 := R2["0x4685E6C3"]
145 [-]: GETUPVAL  R18 U6       ; R18 := U6
146 [-]: GETGLOBAL R19 K8       ; R19 := Game
147 [-]: GETTABLE  R19 R19 K33  ; R19 := R19["AVATAR_SHIELD_RECHARGE_RATE"]
148 [-]: GETGLOBAL R20 K10      ; R20 := Engine
149 [-]: GETTABLE  R20 R20 K11  ; R20 := R20["STACKING_MULTIPLY"]
150 [-]: GETUPVAL  R21 U4       ; R21 := U4
151 [-]: CALL      R16 6 1      ; R16(R17,R18,R19,R20,R21)
152 [-]: GETGLOBAL R16 K34      ; R16 := table
153 [-]: GETTABLE  R16 R16 K35  ; R16 := R16["0xE6450C9D"]
154 [-]: MOVE      R17 R6       ; R17 := R6
155 [-]: MOVE      R18 R1       ; R18 := R1
156 [-]: CALL      R16 3 1      ; R16(R17,R18)
157 [-]: SETTABLE  R5 R3 R1     ; R5[R3] := R1
158 [-]: GETGLOBAL R16 K13      ; R16 := _T
159 [-]: GETTABLE  R16 R16 K14  ; R16 := R16["trinityPassivePvp"]
160 [-]: GETTABLE  R16 R16 R3   ; R16 := R16[R3]
161 [-]: SETTABLE  R16 R3 K15   ; R16[R3] := nil
162 [-]: LEN       R16 R6       ; R16 := # R6
163 [-]: LT        0 K36 R16    ; if 0 >= R16 then PC := 172
164 [-]: JMP       172          ; PC := 172
165 [-]: SETTABLE  R4 K37 R6    ; R4["affected"] := R6
166 [-]: GETTABLE  R16 R6 K38   ; R16 := R6[1]
167 [-]: SELF      R16 R16 K39  ; R17 := R16; R16 := R16["0x584F13D6"]
...
174 [-]: GETGLOBAL R16 K40      ; R16 := 0xECFDD17
175 [-]: GETGLOBAL R17 K13      ; R17 := _T
176 [-]: GETTABLE  R17 R17 K14  ; R17 := R17["trinityPassivePvp"]
...
187 [-]: SELF      R21 R21 K41  ; R22 := R21; R21 := R21["0x5A740E25"]
188 [-]: GETUPVAL  R23 U6       ; R23 := U6
189 [-]: GETGLOBAL R24 K8       ; R24 := Game
190 [-]: GETTABLE  R24 R24 K33  ; R24 := R24["AVATAR_SHIELD_RECHARGE_RATE"]
191 [-]: GETGLOBAL R25 K10      ; R25 := Engine
192 [-]: GETTABLE  R25 R25 K11  ; R25 := R25["STACKING_MULTIPLY"]
193 [-]: GETUPVAL  R26 U4       ; R26 := U4
194 [-]: CALL      R21 6 1      ; R21(R22,R23,R24,R25,R26)
195 [-]: GETGLOBAL R21 K34      ; R21 := table
196 [-]: GETTABLE  R21 R21 K35  ; R21 := R21["0xE6450C9D"]
...
205 [-]: GETTABLE  R21 R21 K14  ; R21 := R21["trinityPassivePvp"]
206 [-]: GETTABLE  R21 R21 R3   ; R21 := R21[R3]
207 [-]: GETTABLE  R21 R21 R3   ; R21 := R21[R3]
208 [-]: EQ        1 R21 K15    ; if R21 == nil then PC := 223
209 [-]: JMP       223          ; PC := 223
210 [-]: SELF      R21 R2 K41   ; R22 := R2; R21 := R2["0x5A740E25"]
211 [-]: GETUPVAL  R23 U6       ; R23 := U6
212 [-]: GETGLOBAL R24 K8       ; R24 := Game
213 [-]: GETTABLE  R24 R24 K33  ; R24 := R24["AVATAR_SHIELD_RECHARGE_RATE"]
214 [-]: GETGLOBAL R25 K10      ; R25 := Engine
215 [-]: GETTABLE  R25 R25 K11  ; R25 := R25["STACKING_MULTIPLY"]
216 [-]: GETUPVAL  R26 U4       ; R26 := U4
217 [-]: CALL      R21 6 1      ; R21(R22,R23,R24,R25,R26)
218 [-]: GETGLOBAL R21 K34      ; R21 := table
219 [-]: GETTABLE  R21 R21 K35  ; R21 := R21["0xE6450C9D"]
220 [-]: MOVE      R22 R6       ; R22 := R6
221 [-]: MOVE      R23 R1       ; R23 := R1
222 [-]: CALL      R21 3 1      ; R21(R22,R23)
223 [-]: LEN       R21 R6       ; R21 := # R6
224 [-]: LT        0 K36 R21    ; if 0 >= R21 then PC := 233
225 [-]: JMP       233          ; PC := 233
226 [-]: SETTABLE  R4 K37 R6    ; R4["affected"] := R6
227 [-]: GETTABLE  R21 R6 K38   ; R21 := R6[1]
228 [-]: SELF      R21 R21 K39  ; R22 := R21; R21 := R21["0x584F13D6"]
229 [-]: MOVE      R23 R4       ; R23 := R4
230 [-]: MOVE      R24 R0       ; R24 := R0
231 [-]: MOVE      R25 R1       ; R25 := R1
232 [-]: CALL      R21 5 1      ; R21(R22,R23,R24,R25)
233 [-]: GETGLOBAL R21 K13      ; R21 := _T
234 [-]: GETTABLE  R21 R21 K14  ; R21 := R21["trinityPassivePvp"]
235 [-]: SETTABLE  R21 R3 R5    ; R21[R3] := R5
236 [-]: GETGLOBAL R21 K42      ; R21 := 0x201191EA
237 [-]: LOADK     R22 K43      ; R22 := 0.10000000149012
...
; Max Stack Size:  16
 ...
 42 [-]: GETGLOBAL R3 K13       ; R3 := _T
 43 [-]: GETTABLE  R3 R3 K14    ; R3 := R3["trinityPassivePvp"]
 44 [-]: EQ        1 R3 K15     ; if R3 == nil then PC := 93
 45 [-]: JMP       93           ; PC := 93
 46 [-]: SELF      R3 R1 K16    ; R4 := R1; R3 := R1["0xDBEF0FB6"]
 47 [-]: CALL      R3 2 2       ; R3 := R3(R4)
 48 [-]: NEWTABLE  R4 0 0       ; R4 := {}
 49 [-]: GETGLOBAL R5 K17       ; R5 := 0xECFDD17
 50 [-]: GETGLOBAL R6 K13       ; R6 := _T
 51 [-]: GETTABLE  R6 R6 K14    ; R6 := R6["trinityPassivePvp"]
 ...
 62 [-]: SELF      R10 R10 K18  ; R11 := R10; R10 := R10["0x5A740E25"]
 63 [-]: GETUPVAL  R12 U4       ; R12 := U4
 64 [-]: GETGLOBAL R13 K8       ; R13 := Game
 65 [-]: GETTABLE  R13 R13 K19  ; R13 := R13["AVATAR_SHIELD_RECHARGE_RATE"]
 66 [-]: GETGLOBAL R14 K10      ; R14 := Engine
 67 [-]: GETTABLE  R14 R14 K11  ; R14 := R14["STACKING_MULTIPLY"]
 68 [-]: GETUPVAL  R15 U5       ; R15 := U5
 69 [-]: CALL      R10 6 1      ; R10(R11,R12,R13,R14,R15)
 70 [-]: GETGLOBAL R10 K20      ; R10 := table
 71 [-]: GETTABLE  R10 R10 K21  ; R10 := R10["0xE6450C9D"]
 ...
 78 [-]: LT        0 K22 R10    ; if 0 >= R10 then PC := 93
 79 [-]: JMP       93           ; PC := 93
 80 [-]: GETGLOBAL R10 K23      ; R10 := Lotus_Game
 81 [-]: GETTABLE  R10 R10 K24  ; R10 := R10["0xFAFD4322"]
 82 [-]: CALL      R10 1 2      ; R10 := R10()
 83 [-]: SETTABLE  R10 K25 R1   ; R10["instigator"] := R1
 84 [-]: SETTABLE  R10 K26 R4   ; R10["affected"] := R4
 85 [-]: GETGLOBAL R11 K28      ; R11 := abilityBuff
 86 [-]: SETTABLE  R10 K27 R11  ; R10["abilityType"] := R11
 87 [-]: GETTABLE  R11 R4 K29   ; R11 := R4[1]
 88 [-]: SELF      R11 R11 K30  ; R12 := R11; R11 := R11["0x584F13D6"]
