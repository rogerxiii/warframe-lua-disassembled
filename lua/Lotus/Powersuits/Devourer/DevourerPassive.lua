...
119 [-]: GETGLOBAL R32 K39      ; R32 := Engine
120 [-]: GETTABLE  R32 R32 K40  ; R32 := R32["ADD"]
...
128 [-]: JMP       137          ; PC := 137
129 [-]: SELF      R29 R4 K41   ; R30 := R4; R29 := R4["0x3B1B11B9"]
130 [-]: GETGLOBAL R31 K37      ; R31 := Game
131 [-]: GETTABLE  R31 R31 K38  ; R31 := R31["AVATAR_ARMOUR"]
132 [-]: GETGLOBAL R32 K39      ; R32 := Engine
133 [-]: GETTABLE  R32 R32 K40  ; R32 := R32["ADD"]
...
139 [-]: SETTABLE  R15 K42 R29  ; R15["buffData"] := R29
140 [-]: SELF      R29 R1 K43   ; R30 := R1; R29 := R1["0x584F13D6"]
...
165 [-]: JMP       182          ; PC := 182
166 [-]: SELF      R29 R1 K44   ; R30 := R1; R29 := R1["0xAB436EF2"]
167 [-]: MOVE      R31 R12      ; R31 := R12
168 [-]: GETGLOBAL R32 K45      ; R32 := EMPTY_SYMBOL
169 [-]: GETGLOBAL R33 K46      ; R33 := ZERO_VECTOR
170 [-]: GETGLOBAL R34 K47      ; R34 := ZERO_ROTATION
...
179 [-]: JMP       182          ; PC := 182
180 [-]: SELF      R29 R14 K48  ; R30 := R14; R29 := R14["0xD4C2743F"]
181 [-]: CALL      R29 2 1      ; R29(R30)
182 [-]: TEST      R27 1        ; if R27 then PC := 191
183 [-]: JMP       191          ; PC := 191
184 [-]: SELF      R29 R11 K49  ; R30 := R11; R29 := R11["0xDB349344"]
185 [-]: GETGLOBAL R31 K50      ; R31 := math
186 [-]: GETTABLE  R31 R31 K51  ; R31 := R31["0x65F9712A"]
...
232 [-]: SELF      R29 R1 K44   ; R30 := R1; R29 := R1["0xAB436EF2"]
233 [-]: MOVE      R31 R13      ; R31 := R13
234 [-]: GETUPVAL  R32 U1       ; R32 := U1
235 [-]: GETGLOBAL R33 K46      ; R33 := ZERO_VECTOR
236 [-]: GETGLOBAL R34 K47      ; R34 := ZERO_ROTATION
237 [-]: MOVE      R35 R0       ; R35 := R0
238 [-]: CALL      R29 7 1      ; R29(R30,R31,R32,R33,R34,R35)
239 [-]: JMP       262          ; PC := 262
240 [-]: TEST      R27 0        ; if not R27 then PC := 262
241 [-]: JMP       262          ; PC := 262
242 [-]: SELF      R29 R11 K53  ; R30 := R11; R29 := R11["0xC4E503B0"]
243 [-]: CALL      R29 2 2      ; R29 := R29(R30)
244 [-]: GETTABLE  R30 R11 K57  ; R30 := R11["mTargetVal"]
245 [-]: MUL       R30 R30 K58  ; R30 := R30 * 0.99000000953674
246 [-]: LT        0 R30 R29    ; if R30 >= R29 then PC := 262
247 [-]: JMP       262          ; PC := 262
248 [-]: GETGLOBAL R29 K14      ; R29 := 0x70D42C02
249 [-]: SELF      R30 R11 K53  ; R31 := R11; R30 := R11["0xC4E503B0"]
...
254 [-]: SELF      R29 R11 K49  ; R30 := R11; R29 := R11["0xDB349344"]
255 [-]: GETGLOBAL R31 K50      ; R31 := math
256 [-]: GETTABLE  R31 R31 K51  ; R31 := R31["0x65F9712A"]
...
262 [-]: SELF      R29 R11 K59  ; R30 := R11; R29 := R11["0x8C7099E9"]
263 [-]: GETGLOBAL R31 K60      ; R31 := 0x4CDEF9FF
264 [-]: CALL      R31 1 0      ; R31,... := R31()
265 [-]: CALL      R29 0 1      ; R29(R30,...)
266 [-]: SELF      R29 R11 K53  ; R30 := R11; R29 := R11["0xC4E503B0"]
...
318 [-]: GETTABLE  R33 R18 K66  ; R33 := R18["x"]
319 [-]: MUL       R33 R33 R32  ; R33 := R33 * R32
320 [-]: SETTABLE  R18 K66 R33  ; R18["x"] := R33
321 [-]: GETTABLE  R33 R18 K67  ; R33 := R18["y"]
322 [-]: MUL       R33 R33 R32  ; R33 := R33 * R32
323 [-]: SETTABLE  R18 K67 R33  ; R18["y"] := R33
324 [-]: GETTABLE  R33 R18 K68  ; R33 := R18["z"]
325 [-]: MUL       R33 R33 R32  ; R33 := R33 * R32
326 [-]: SETTABLE  R18 K68 R33  ; R18["z"] := R33
327 [-]: GETGLOBAL R33 K69      ; R33 := 0x6374FD98
328 [-]: GETTABLE  R34 R16 K66  ; R34 := R16["x"]
329 [-]: MUL       R34 R34 R25  ; R34 := R34 * R25
330 [-]: MUL       R34 R34 R29  ; R34 := R34 * R29
331 [-]: LOADK     R35 K70      ; R35 := -0.20000000298023
332 [-]: LOADK     R36 K71      ; R36 := 0.20000000298023
333 [-]: CALL      R33 4 2      ; R33 := R33(R34,R35,R36)
334 [-]: SETTABLE  R16 K66 R33  ; R16["x"] := R33
335 [-]: GETGLOBAL R33 K69      ; R33 := 0x6374FD98
336 [-]: GETTABLE  R34 R16 K67  ; R34 := R16["y"]
337 [-]: MUL       R34 R34 R25  ; R34 := R34 * R25
338 [-]: MUL       R34 R34 R29  ; R34 := R34 * R29
339 [-]: LOADK     R35 K70      ; R35 := -0.20000000298023
340 [-]: LOADK     R36 K71      ; R36 := 0.20000000298023
341 [-]: CALL      R33 4 2      ; R33 := R33(R34,R35,R36)
342 [-]: SETTABLE  R16 K67 R33  ; R16["y"] := R33
343 [-]: GETGLOBAL R33 K69      ; R33 := 0x6374FD98
344 [-]: GETTABLE  R34 R16 K68  ; R34 := R16["z"]
345 [-]: MUL       R34 R34 R25  ; R34 := R34 * R25
346 [-]: MUL       R34 R34 R29  ; R34 := R34 * R29
347 [-]: LOADK     R35 K70      ; R35 := -0.20000000298023
348 [-]: LOADK     R36 K71      ; R36 := 0.20000000298023
349 [-]: CALL      R33 4 2      ; R33 := R33(R34,R35,R36)
350 [-]: SETTABLE  R16 K68 R33  ; R16["z"] := R33
351 [-]: GETGLOBAL R33 K63      ; R33 := 0x4CBE9A09
352 [-]: MOVE      R34 R16      ; R34 := R16
353 [-]: GETGLOBAL R35 K72      ; R35 := 0x3EEF873
354 [-]: SELF      R36 R1 K73   ; R37 := R1; R36 := R1["0xF23A7849"]
355 [-]: CALL      R36 2 0      ; R36,... := R36(R37)
356 [-]: CALL      R35 0 0      ; R35,... := R35(R36,...)
357 [-]: CALL      R33 0 2      ; R33 := R33(R34,...)
358 [-]: MOVE      R17 R33      ; R17 := R33
359 [-]: GETTABLE  R33 R17 K66  ; R33 := R17["x"]
360 [-]: MUL       R33 R33 K75  ; R33 := R33 * 120
361 [-]: SETTABLE  R26 K74 R33  ; R26["heading"] := R33
362 [-]: GETTABLE  R33 R17 K67  ; R33 := R17["y"]
363 [-]: MUL       R33 R33 K77  ; R33 := R33 * 300
364 [-]: SETTABLE  R26 K76 R33  ; R26["pitch"] := R33
365 [-]: GETGLOBAL R33 K78      ; R33 := 0x93034B55
366 [-]: MOVE      R34 R7       ; R34 := R7
367 [-]: MOVE      R35 R8       ; R35 := R8
368 [-]: MOVE      R36 R29      ; R36 := R29
369 [-]: CALL      R33 4 2      ; R33 := R33(R34,R35,R36)
370 [-]: SETTABLE  R9 K66 R33   ; R9["x"] := R33
371 [-]: GETTABLE  R33 R9 K66   ; R33 := R9["x"]
372 [-]: SETTABLE  R9 K67 R33   ; R9["y"] := R33
373 [-]: GETTABLE  R33 R9 K66   ; R33 := R9["x"]
374 [-]: SETTABLE  R9 K68 R33   ; R9["z"] := R33
375 [-]: SELF      R33 R1 K79   ; R34 := R1; R33 := R1["0x6B85BD4"]
...
381 [-]: GETGLOBAL R33 K80      ; R33 := 0x201191EA
...
; Max Stack Size:  15
 ...
 45 [-]: GETGLOBAL R7 K15       ; R7 := Engine
 46 [-]: GETTABLE  R7 R7 K16    ; R7 := R7["ADD"]
 47 [-]: MOVE      R8 R3        ; R8 := R3
 48 [-]: CALL      R4 5 1       ; R4(R5,R6,R7,R8)
 49 [-]: GETGLOBAL R4 K17       ; R4 := Lotus_Game
 50 [-]: GETTABLE  R4 R4 K18    ; R4 := R4["0xFAFD4322"]
 51 [-]: CALL      R4 1 2       ; R4 := R4()
 52 [-]: SETTABLE  R4 K19 R1    ; R4["instigator"] := R1
 53 [-]: NEWTABLE  R5 1 0       ; R5 := {}
 54 [-]: MOVE      R6 R1        ; R6 := R1
 55 [-]: SETLIST   R5 1 1       ; R5[(1-1)*FPF+i] := R(5+i), 1 <= i <= 1
 56 [-]: SETTABLE  R4 K20 R5    ; R4["affected"] := R5
 57 [-]: GETGLOBAL R5 K21       ; R5 := abilityType
 58 [-]: SETTABLE  R4 K21 R5    ; R4["abilityType"] := R5
 59 [-]: SELF      R5 R1 K22    ; R6 := R1; R5 := R1["0x584F13D6"]
 60 [-]: MOVE      R7 R4        ; R7 := R4
 61 [-]: MOVE      R8 R0        ; R8 := R0
 62 [-]: MOVE      R9 R0        ; R9 := R0
 63 [-]: CALL      R5 5 1       ; R5(R6,R7,R8,R9)
 64 [-]: SELF      R5 R1 K23    ; R6 := R1; R5 := R1["0x9F1DC568"]
 65 [-]: SELF      R7 R0 K24    ; R8 := R0; R7 := R0["0xDD9E6F2D"]
 66 [-]: GETGLOBAL R9 K25       ; R9 := 0xEC274B1A
 67 [-]: LOADK     R10 K26      ; R10 := "DigestingEffect"
 ...
 75 [-]: JMP       78           ; PC := 78
 76 [-]: SELF      R6 R5 K27    ; R7 := R5; R6 := R5["0xD4C2743F"]
 77 [-]: CALL      R6 2 1       ; R6(R7)
 78 [-]: SELF      R6 R1 K28    ; R7 := R1; R6 := R1["0x6B85BD4"]
 79 [-]: GETGLOBAL R8 K25       ; R8 := 0xEC274B1A
 80 [-]: LOADK     R9 K29       ; R9 := "GAME_C1_BELLY1"
 81 [-]: CALL      R8 2 2       ; R8 := R8(R9)
 82 [-]: GETGLOBAL R9 K30       ; R9 := ZERO_ROTATION
 83 [-]: GETGLOBAL R10 K31      ; R10 := ZERO_VECTOR
 84 [-]: GETGLOBAL R11 K32      ; R11 := 0x221C9700
 85 [-]: LOADK     R12 K33      ; R12 := 1
 86 [-]: LOADK     R13 K33      ; R13 := 1
 87 [-]: LOADK     R14 K33      ; R14 := 1
