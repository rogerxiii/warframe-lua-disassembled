...
; Command line was: -dis M:\git repos\warframe-lua-disassembled\B.Font.cache_extracted\Lotus\Powersuits\Archwing\ArchwingAbilities\ExhaustTrail.luac 
...
; Max Stack Size:  8
  ...
  8 [-]: JMP       22           ; PC := 22
  9 [-]: SELF      R3 R1 K3     ; R4 := R1; R3 := R1["0x8DB5D01F"]
 10 [-]: CALL      R3 2 2       ; R3 := R3(R4)
 11 [-]: SELF      R3 R3 K4     ; R4 := R3; R3 := R3["0xE81AC1B1"]
 ...
 17 [-]: JMP       22           ; PC := 22
 18 [-]: SELF      R4 R3 K5     ; R5 := R3; R4 := R3["0xFD910504"]
 19 [-]: LOADK     R6 K1        ; R6 := 1
 ...
 25 [-]: GETTABLE  R6 R6 K7     ; R6 := R6["PowerSuit_AUGMENT_ONE"]
 26 [-]: CALL      R4 3 1       ; R4(R5,R6)
 27 [-]: GETUPVAL  R4 U1        ; R4 := U1
 28 [-]: MOVE      R5 R1        ; R5 := R1
 29 [-]: CALL      R4 2 3       ; R4,R5 := R4(R5)
 30 [-]: GETGLOBAL R6 K8        ; R6 := 0x201191EA
 31 [-]: MOVE      R7 R5        ; R7 := R5
 32 [-]: CALL      R6 2 1       ; R6(R7)
 33 [-]: SELF      R6 R0 K9     ; R7 := R0; R6 := R0["0xD4C2743F"]
