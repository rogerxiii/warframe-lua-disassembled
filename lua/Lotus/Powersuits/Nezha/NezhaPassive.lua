...
; Max Stack Size:  10
 ...
 25 [-]: SELF      R3 R2 K8     ; R4 := R2; R3 := R2["0x6609891F"]
 26 [-]: GETGLOBAL R5 K9        ; R5 := Game
 27 [-]: GETTABLE  R5 R5 K10    ; R5 := R5["NONE"]
 28 [-]: LOADNIL   R6 R7        ; R6 := R7 := nil
 29 [-]: GETGLOBAL R8 K11       ; R8 := 0xEC274B1A
 30 [-]: LOADK     R9 K12       ; R9 := "DisablePassive"
...
; Max Stack Size:  10
 ...
 22 [-]: SELF      R3 R2 K6     ; R4 := R2; R3 := R2["0x6609891F"]
 23 [-]: GETGLOBAL R5 K7        ; R5 := Game
 24 [-]: GETTABLE  R5 R5 K8     ; R5 := R5["NONE"]
 25 [-]: LOADNIL   R6 R7        ; R6 := R7 := nil
 26 [-]: GETGLOBAL R8 K9        ; R8 := 0xEC274B1A
 27 [-]: LOADK     R9 K10       ; R9 := "DisablePassive"
 ...
 35 [-]: GETGLOBAL R5 K7        ; R5 := Game
 36 [-]: GETTABLE  R5 R5 K11    ; R5 := R5["0x1B694258"]
 37 [-]: CALL      R5 1 2       ; R5 := R5()
 38 [-]: SELF      R6 R5 K12    ; R7 := R5; R6 := R5["0x15C954A"]
 39 [-]: GETGLOBAL R8 K7        ; R8 := Game
 40 [-]: GETTABLE  R8 R8 K13    ; R8 := R8["STACKING_MULTIPLY"]
 41 [-]: CALL      R6 3 1       ; R6(R7,R8)
 42 [-]: SELF      R6 R5 K14    ; R7 := R5; R6 := R5["0x46206C58"]
 43 [-]: GETGLOBAL R8 K7        ; R8 := Game
 44 [-]: GETTABLE  R8 R8 K15    ; R8 := R8["AVATAR_SLIDE_FRICTION"]
 45 [-]: CALL      R6 3 1       ; R6(R7,R8)
 46 [-]: SELF      R6 R5 K16    ; R7 := R5; R6 := R5["0x6733C272"]
 47 [-]: MOVE      R8 R4        ; R8 := R4
 48 [-]: CALL      R6 3 1       ; R6(R7,R8)
 49 [-]: SELF      R6 R2 K17    ; R7 := R2; R6 := R2["0xF21555A7"]
 50 [-]: MOVE      R8 R5        ; R8 := R5
 51 [-]: CALL      R6 3 1       ; R6(R7,R8)
 52 [-]: SELF      R6 R5 K14    ; R7 := R5; R6 := R5["0x46206C58"]
 53 [-]: GETGLOBAL R8 K7        ; R8 := Game
 54 [-]: GETTABLE  R8 R8 K18    ; R8 := R8["AVATAR_SLIDE_BOOST"]
 55 [-]: CALL      R6 3 1       ; R6(R7,R8)
 56 [-]: SELF      R6 R5 K16    ; R7 := R5; R6 := R5["0x6733C272"]
 57 [-]: MOVE      R8 R3        ; R8 := R3
 58 [-]: CALL      R6 3 1       ; R6(R7,R8)
 59 [-]: SELF      R6 R2 K17    ; R7 := R2; R6 := R2["0xF21555A7"]
 60 [-]: MOVE      R8 R5        ; R8 := R5
 61 [-]: CALL      R6 3 1       ; R6(R7,R8)
 62 [-]: SELF      R6 R5 K16    ; R7 := R5; R6 := R5["0x6733C272"]
 63 [-]: UNM       R8 R3        ; R8 := - R3
 64 [-]: CALL      R6 3 1       ; R6(R7,R8)
 65 [-]: SELF      R6 R5 K19    ; R7 := R5; R6 := R5["0xD6538985"]
 66 [-]: GETGLOBAL R8 K20       ; R8 := Engine
 67 [-]: GETTABLE  R8 R8 K21    ; R8 := R8["PM_IN_AIR"]
 68 [-]: MOVE      R9 R1        ; R9 := R1
 69 [-]: CALL      R6 4 1       ; R6(R7,R8,R9)
 70 [-]: SELF      R6 R2 K17    ; R7 := R2; R6 := R2["0xF21555A7"]
 71 [-]: MOVE      R8 R5        ; R8 := R5
