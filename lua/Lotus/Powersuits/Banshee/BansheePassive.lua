...
; Command line was: -dis M:\git repos\warframe-lua-disassembled\lua\Lotus\Powersuits\Banshee\BansheePassive.luac 
...
; Max Stack Size:  3
  ...
  6 [-]: MOVE      R0 R0        ; R0 := R0
  7 [-]: MOVE      R0 R1        ; R0 := R1
  8 [-]: SETGLOBAL R2 K3        ; AddUpgrades := R2
  9 [-]: SETGLOBAL R2 K4        ; 0xF9821444 := R2
 10 [-]: CLOSURE   R2 1         ; R2 := closure(Function #2)
 11 [-]: MOVE      R0 R0        ; R0 := R0
 12 [-]: MOVE      R0 R1        ; R0 := R1
 13 [-]: SETGLOBAL R2 K5        ; RemoveUpgrades := R2
 14 [-]: SETGLOBAL R2 K6        ; 0x698F6403 := R2
...
; Max Stack Size:  7
 ...
 23 [-]: GETTABLE  R4 R4 K8     ; R4 := R4["WEAPON_NOISE_REDUCTION"]
 24 [-]: GETGLOBAL R5 K9        ; R5 := Engine
 25 [-]: GETTABLE  R5 R5 K10    ; R5 := R5["MULTIPLY"]
